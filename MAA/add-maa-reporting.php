...
<?php if (isset($_REQUEST['submit']) && $_REQUEST['submit'] == "Submit") {
	...
	//echo "insert into maa_monthly_report set $insqrys status=0";
	$ints = mysqli_query($conn, "insert into maa_monthly_report set $insqrys status=0");
	if ($ints) {
			...
			<table cellspacing="0" border="0" cellpadding="5">
				...
				<tr>
					...
					<td style="" align="left" valign=middle bgcolor="#E7E6E6">
						<div style="vertical-align:middle">
							...
							<div style="float:right; width:50%"> <select class="form-select" id="block" name="block" required="">
				...
				<tr>
					<td style="" colspan=3 align="left" valign=middle bgcolor="#E7E6E6" data-sheets-value="{ &quot;1&quot;: 2, &quot;2&quot;: &quot;जिला का नामः&quot;}">
						<font face="Noto Sans" color="#000000">Name of MAA Program Nodal Officer</font>:
					</td>
					<td style="" colspan=1 align="left" valign=middle bgcolor="#E7E6E6" data-sheets-value="{ &quot;1&quot;: 2, &quot;2&quot;: &quot;जिला का नामः&quot;}">
						<font color="#000000"><input type="text" name="nodal_officer_name" class="form-control"></font>
					</td>

					<td style="" align="left" valign=middle bgcolor="#E7E6E6" data-sheets-value="{ &quot;1&quot;: 2, &quot;2&quot;: &quot;जिला का नामः&quot;}">
						<font face="Noto Sans" color="#000000">Contact</font>:
					</td>
					<td style="" colspan=2 align="left" valign=middle bgcolor="#E7E6E6" data-sheets-value="{ &quot;1&quot;: 2, &quot;2&quot;: &quot;जिला का नामः&quot;}">
						<font color="#000000"><input style="background-color:#fff" type="mobile" maxlength="10" name="nodal_officer_contact" class="form-control"></font>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="total_nos_asha" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					<td colspan=1 height="39" align="center" valign=bottom sdval="1" sdnum="1033;">
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="ashas_oriented_iycf" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					<td colspan=1 height="39" align="center" valign=bottom sdval="1" sdnum="1033;">
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="ashas_with_infokit" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					<td colspan=1 height="39" align="center" valign=bottom sdval="1" sdnum="1033;">
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="ashas_conducted_meetings" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					<td colspan=1 height="39" align="center" valign=bottom sdval="1" sdnum="1033;">
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="ashas_received_incentive" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="pregnant_mothers" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					<td colspan=4 align="left" valign=middle>
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="lactating_mothers" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="total_mothers" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					<td colspan=1 height="39" align="center" valign=bottom sdval="1" sdnum="1033;">
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="mothers_participated_meeting" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					<td colspan=1 height="39" align="center" valign=bottom sdval="1" sdnum="1033;">
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="iycf_master_trainers" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					<td colspan=1 height="39" align="center" valign=bottom sdval="1" sdnum="1033;">
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="mothers_meetings_held" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="staff_sensitized" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					<td colspan=4 align="left" valign=middle>
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="delivery_points_sensitized" class="form-control" required></font>
					</td>
				</tr>
				<tr>
					<td colspan=1 height="39" align="center" valign=bottom sdval="1" sdnum="1033;">
					...
					<td style="text-align:center" colspan=2 align="center" valign=bottom colspan="3">
						<font color="#000000"><input type="number" name="facilities_given_maa_award" class="form-control" required></font>
					</td>
				</tr>
				<tr>
			...
			<table cellspacing="0" border="0" cellpadding="5">
				...
				<tbody>
					<tr>
						<td height="39">A</td>
						<td>Posted</td>
						<td><input type="number" name="posted_medical_officer" class="form-control "></td>

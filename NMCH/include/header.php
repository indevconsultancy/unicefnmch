    ...
    <header id="page-topbar" class="header bg-primary">
        <div class="layout-width">
            <div class="navbar-header">
                <div class="d-flex">
                    <!-- LOGO -->
                    <div class="navbar-brand-box horizontal-logo d-flex">
                        <a href="index.php" class="logo text-white">
						<img src="assets/images/nmch-logo.png" width="80">
						<h2 class="text-white">State Resource Center <span>Nalanada Medical College Hospital, Patna</span></h2>
        ...
        <div id="scrollbar">
            <div class="container container-fluid">
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="blank-page.php" data-bs-toggle="collapse"
                            role="button" aria-expanded="false" aria-controls="sidebarMultilevel"> <span data-key="t-multi-level">Blank Page</span>
                        </a>
                    </li>

...
if (isset($_REQUEST['submit'])) {
	...
	if ($scaptcha == $captcha) {
		...
		if ($email != '') {
			...
			$mail->IsHTML(true);
			$mail->Username = "info@mquad.org11";
				...
				<div class="socialContent">
					<div>
						<div class="dedooseSupport">
							<h3>Support</h3>
							<p>E-Mail: <a href="mquad.io@gmail.com">contact@indevconsultancy.com</a></p>
							<p>Phone No.: <span style="color: #8cc63f">+91 011-35352929</span></p>
							<p>Address: <span style="color: #8cc63f">E-40/3, 2nd Floor, Okhla Industrial Area, Phase II, New Delhi - 110020, India</span></p>
							<br />
						</div>

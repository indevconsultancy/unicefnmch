...
$formdata='aUjYspbGxT8m3J9Tjmv62c';
$table='aujyspbgxt8m3j9tjmv62c1';
//$start=$_GET['countId'];
$start=0;
$api_url = 'https://eu.kobotoolbox.org/api/v2/assets/'.$formdata.'/data/?format=json&start='.$start.'&limit=1';

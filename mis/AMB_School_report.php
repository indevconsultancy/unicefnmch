                ...
                <div class="table-responsive">
                    <table id="simpleTable1" data-cols-width="60,50,10">
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$V2aww= getcountAMB($conn, 'alyuvdbzgkrn32dndgkebw', 'id', '_1_1_Has_a_nodal_teac_or_AMB_in_the_school', 'no', '', '') ?></td>
                            <td data-fill-color="F2F2F2"><?=$V2tot?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=round(((($V2aww)*100)/($V2tot)),0) ?>%</td>
                        </tr>
                        ...
                        <tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">No</td>
                            <td data-fill-color="F2F2F2"><?=$Vb1n= getcountAMB($conn, 'alyuvdbzgkrn32dndgkebw', 'id', '_3_2_Is_Anaemia_Scree_ducted_in_the_School', 'no', '', '') ?></td>
                        ...
                        <tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">No</td>
                            <td data-fill-color="F2F2F2"><?=$Vb1n= getcountAMB($conn, 'alyuvdbzgkrn32dndgkebw', 'id', '_4_1_Was_weekly_IFA_b_3_months_every_week', 'no', '', '') ?></td>
                            <td data-fill-color="F2F2F2"><?=$Vb1tot?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=round(((($Vb1n)*100)/($Vb1tot)),0) ?>%</td>
                        </tr>
						<tr data-weight="140">
                        ...
                        <tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">No</td>
                            <td data-fill-color="F2F2F2"><?=$Vc2= getcountAMB($conn, 'alyuvdbzgkrn32dndgkebw', 'id', '_6_3_Whether_any_stock_out_of_I', 'no', '', '') ?></td>
                            <td data-fill-color="F2F2F2"><?=$Vctot?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($Vc2)*100)/($Vctot)),1),1) ?>%</td>
                        </tr>
                        ...
                        <tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">No</td>
                            <td data-fill-color="F2F2F2"><?=$Vc2= getcountAMB($conn, 'alyuvdbzgkrn32dndgkebw', 'id', '_6_4_Is_there_enough_stock_of_I', 'no', '', '') ?></td>
                            <td data-fill-color="F2F2F2"><?=$Vctot?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($Vc2)*100)/($Vctot)),1),1) ?>%</td>
                        </tr>
						<tr data-weight="140">
                        ...
                        <tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">No</td>
                            <td data-fill-color="F2F2F2"><?=$Vc2= getcountAMB($conn, 'alyuvdbzgkrn32dndgkebw', 'id', '_6_5_Is_the_available_IFA_withi', 'no', '', '') ?></td>
                            <td data-fill-color="F2F2F2"><?=$Vctot?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($Vc2)*100)/($Vctot)),1),1) ?>%</td>
                        </tr>
						<tr data-weight="140">
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$V2asha= getcountAMB($conn, 'alyuvdbzgkrn32dndgkebw', 'id', '_7_3_Is_updated_distr_r_available_Observe', 'available_and_updated', '', '') ?></td>
                            <td data-fill-color="F2F2F2"><?=$V2tot?></td>
						...
						<tr data-weight="140">
                            <td style="font-weight: 600; border-bottom: 1px solid black;text-align:left!important;vertical-align:middle;text-align:left!important;vertical-align:middle;" data-b-b-s="thin" data-b-b-c="0000FF" rowspan="2" data-a-v="middle" data-f-bold="true" data-fill-color="F2F2F2">Respondent know about benefits of IFA prophylaxis </td>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right" data-a-h="right">Yes</td>

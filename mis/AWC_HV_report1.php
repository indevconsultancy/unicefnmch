...
function getTotalAWCHV($conn, $tablename, $field, $qryfield, $value, $qryfield1 = '', $value1 = '') {
    $qry = "";
	if (isset($_REQUEST['search'])) {
		if($qryfield1=='')
		{
    ...
    $query = "SELECT SUM($field) as total FROM $tablename WHERE $qryfield='$value' $qry";
    $result = mysqli_query($conn, $query);
    $row = mysqli_fetch_object($result);
			...
			<div class="col-lg-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><i class="fa fa-calandar"></i>AWC Analysis Report</li>
					</ol>
				...
				<div class="row filter_css clearfix g-1">
					<div class="col-lg-2 col-md-4 col-sm-12">
						<div class="form-group">
							...
							$allDistricts='';
							$selected=''; $kl=1;
							$qryDistrictType = mysqli_query($conn, "SELECT distinct(district) from aujyspbgxt8m3j9tjmv62c3");
					...
					<div class="col-lg-2 col-md-3 col-sm-12">
						<div class="form-group"> 
							...
							<?php 
							$selected='';
							$qryUserType = mysqli_query($conn,"SELECT DISTINCT type_mon FROM aujyspbgxt8m3j9tjmv62c3 ORDER BY type_mon ASC");
			...
			<section class="panel p-1">
				<div class="table-responsive" >
					<table cellspacing="0" id="simpleTable1" data-cols-width="60,50,10" >
						...
						<tr>
							<td class="header1" colspan="<?= 5 + (3 * $m) ?>" data-f-sz="22" data-a-h="center" data-b-a-s="thin" data-b-a-c="000000" data-f-color="FFFFFF" data-fill-color="00B0F0" data-b-r-s="thick" data-b-r-c="000000" data-b-t-s="thick" data-b-t-c="000000" data-f-bold="true"><b>AWC Monitoring <?php if($first==$last) { ?> <?=date('F-Y',strtotime($last))?> <?php } else { ?> <?=date('F',strtotime($first))?> - <?=date('F Y',strtotime($last))?> <?php } ?> Bihar (<?php if($districtText!='') { echo ucwords($districtText); } else { echo $allDistricts; }  ?>)</b></td>
						</tr>
						<tr>
							...
							<td colspan=3 class="header1ss" data-f-color="FFFFFF" data-fill-color="00B0F0" data-b-a-s="thin" data-b-a-c="000000" data-f-sz="14" data-f-bold="true"><b>
                                 <?php if($first==$last) { ?> <?=date('F-Y',strtotime($last))?> <?php } else { ?> <?=date('F',strtotime($first))?> - <?=date('F Y',strtotime($last))?> <?php } ?>
								</b>
							</td>
							<?php // for ($i = 0; $i < $m; $i++) { 
							?>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="26" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'func_child_wm', 'fun', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'func_child_wm!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="26" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'Func_adult_wm', 'fun', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'Func_adult_wm!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="65" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?></b>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="26" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'func_infanto', 'fun', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'func_infanto!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="65" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?></b>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="26" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'func_stadio', 'fun', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'func_stadio!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="65" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?></b>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="26" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_handout', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_handout!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="65" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?></b>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="26" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'CMAM_manual', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'CMAM_manual!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="65" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?></b>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="26" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'smart_m_pt', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'smart_m_pt!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="65" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?></b>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="26" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'coun_mat__kat_cham', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">

								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'coun_mat__kat_cham>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="65" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?></b>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="8" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'coun_mat__coun_card', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'coun_mat__coun_card>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="2" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'coun_mat__pos_kit', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'coun_mat__pos_kit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="17" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'coun_mat__mcp_car', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'coun_mat__mcp_car>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="8" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'coun_mat__na', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'coun_mat__na>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="20" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="31" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_mal', 'sam', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_mal!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="1" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_mal', 'mam', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_mal!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="1" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_mal', 'suw', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_mal!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="0" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_mal', 'uw', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_mal!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="7" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_mal', 'dnk', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_mal!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="32" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_screen_sam', 'wt_hl', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_screen_sam!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="80" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="0" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_screen_sam', 'l_h_age', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_screen_sam!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="6" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_screen_sam', 'w_age', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_screen_sam!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="2" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_screen_sam', 'dnk', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_screen_sam!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="31" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_sam_identify__pt', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_sam_identify__pt>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="77.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="13" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_sam_identify__wlh_ref_chart', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_sam_identify__wlh_ref_chart>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="9" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_sam_identify__mcp_card_gc', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_sam_identify__mcp_card_gc>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="4" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_sam_identify__not_aw', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_sam_identify__not_aw>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="10" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="6" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_bl_pitting', 'aware', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_aware_bl_pitting!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="15" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="17" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__st_1', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__st_1>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="42.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="6" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__st_2', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__st_2>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="15" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="15" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__st_3', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__st_3>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="10" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__st_4', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__st_4>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="5" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__st_5', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__st_5>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__dnk', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mgmt_steps__dnk>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="12" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_first_ref', 'vhsnd', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_first_ref!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="30" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="11" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_first_ref', 'nrc', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_first_ref!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="5" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_first_ref', 'chc_phc_rbsk', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_first_ref!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="2" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_first_ref', 'awc', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_first_ref!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="10" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_first_ref', 'dnk', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_first_ref!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="15" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mt', 'aware', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_mt!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="37.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="2" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__anti', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__anti>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="3" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__foli', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__foli>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="7" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__albe', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__albe>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="17.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="9" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__vlta', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__vlta>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="22.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="16" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__iron', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__iron>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="40" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="4" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__multivit', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__multivit>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="10" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="24" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__dnk', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_med__dnk>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="60" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="15" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'mt_poor_app', 'aware', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'mt_poor_app!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="37.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="12" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'improve_nutri__week', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'improve_nutri__week>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="30" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="18" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'improve_nutri__coun', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'improve_nutri__coun>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="3" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'improve_nutri__awc_sess', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'improve_nutri__awc_sess>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="7.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="15" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'improve_nutri__prov_thr', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'improve_nutri__prov_thr>', '0', $qryparam, '') ?>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="17" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'improve_nutri__dnk', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'improve_nutri__dnk>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="42.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="16" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__add_ghee', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__add_ghee>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="40" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="16" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__three_m_2_sn', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__three_m_2_sn>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="40" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="11" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__add_ground_soya_sattu', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__add_ground_soya_sattu>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="27.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="31" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__milk', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__milk>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="77.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__egg', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__egg>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="20" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__sea_fruit', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__sea_fruit>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="50" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="26" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__green_yellow_veg', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__green_yellow_veg>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="65" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="7" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__thr_snack', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__thr_snack>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="17.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="13" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__bi_ifa', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__bi_ifa>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="32.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="7" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__dnk', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'nuri_msg__dnk>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="17.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="12" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_progress_fup__week', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_progress_fup__week>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="30" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="8" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_progress_fup__mont', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_progress_fup__mont>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="20" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="1" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_progress_fup__awc_session', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_progress_fup__awc_session>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="2.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="25" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_progress_fup__dnk', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_progress_fup__dnk>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="2" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_not_resp', 'vhsnd_session', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_not_resp!', 'vhsnd_session', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="2" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_not_resp', 'nrc', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_not_resp!', 'nrc', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="2" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_not_resp', 'chc_phc_rbsk', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_not_resp!', 'chc_phc_rbsk', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="2" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_not_resp', 'dnk', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_not_resp!', 'dnk', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="18" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__weighing', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__weighing>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="45" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="18" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__moni_wt', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__moni_wt>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="45" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="18" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__check_ill_sign', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__check_ill_sign>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="45" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="18" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__check_med_comp', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__check_med_comp>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="45" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="18" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__check_rd', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__check_rd>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="45" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="18" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__couns_hyg_diet', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__couns_hyg_diet>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="45" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="18" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__rec_maintain', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__rec_maintain>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="45" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="18" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__dnk', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_activites__dnk>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="45" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="6" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_duration', 'aware', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'fup_duration>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="15" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							<td class="header-main" data-a-wrap="true" data-b-a-s="thin" data-b-a-c="000000" data-a-h="left" data-a-v="middle" data-fill-color="FDE9D9" data-f-sz="12" rowspan=3>
								AWW knowledge - Action if a child continues to remain in SAM category even after 3 months follow up period in CMAM program?
							</td>
							<td class="header-submain" data-b-a-s="thin" data-a-wrap="true" data-b-a-c="000000" data-a-h="left" data-a-v="middle" data-fill-color="FDE9D9" data-f-sz="11">
								Refer to NRC/Health Facility
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="17" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'what_done_aft_3mon', 'refer_nrc', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'what_done_aft_3mon!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="42.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="17" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'what_done_aft_3mon', 'continue_int_fup', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'what_done_aft_3mon!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="17" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'what_done_aft_3mon', 'dnk', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'what_done_aft_3mon!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__child_below_2r', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__child_below_2r>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__firm_place', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__firm_place>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__head_corr', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__head_corr>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__child_body_p', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__child_body_p>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__child_foot_corr', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__child_foot_corr>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__supp_add_person', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__supp_add_person>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__sam_less2_na', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_infanto__sam_less2_na>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_salter__scale_hanged_corr', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_salter__scale_hanged_corr>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_salter__cal_zero', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_salter__cal_zero>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_salter__min_cloth', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_salter__min_cloth>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', '`aww_skill_salter__pointer-static`', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', '`aww_skill_salter__pointer-static`>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_salter__sam_less2_na', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_salter__sam_less2_na>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__child_gr_2yr', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__child_gr_2yr>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__firm_place', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__firm_place>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__child_feet_p', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__child_feet_p>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__child_body_p', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__child_body_p>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__stadio_touch_head', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__stadio_touch_head>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__corr_eye_pos', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__corr_eye_pos>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__supp_add_person', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__supp_add_person>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__sam_gr2_na', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_stadio__sam_gr2_na>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_dws__flat_sur', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_dws__flat_sur>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_dws__tared_zero', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_dws__tared_zero>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_dws__min_cloth', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_dws__min_cloth>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_dws__child_centre_ws', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_dws__child_centre_ws>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="21" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_dws__sam_gr2_na', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_skill_dws__sam_gr2_na>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="52.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="17" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_trg_sam', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_trg_sam!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="42.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="3023" sdnum="1033;">
								<?=getTotalAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'reg_05', 'reg_05>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="2768" sdnum="1033;">
								<?=$n=getTotalAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'mes_05', 'mes_05>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center">
								<?=$d=getTotalAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'reg_05', 'reg_05>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdnum="1033;0;0.0"><b>
								<?= round((($n * 100) / $d), 0) ?>	
								</b></td> 
							<?php for ($i = 0; $i < $m; $i++) {  $qryparam=$fullfilter[$i]; ?>
								...
								<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center">
									<?=$n=getTotalAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'reg_05', 'reg_05>', '0', $qryparam, '') ?>
								</td>
								<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
									</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="68" sdnum="1033;">
								<?=$n=getTotalAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'no_sam', 'no_sam>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center">
								<?=$d=getTotalAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'reg_05', 'reg_05>', '0', $qryparam, '') ?>
							</td>
							...
							<?php for ($i = 0; $i < $m; $i++) {  $qryparam=$fullfilter[$i]; ?>
								<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="4" sdnum="1033;">
									<?=getTotalAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'no_sam', 'no_sam>', '0', $qryparam, '') ?>
								</td>
								<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center">
									<?=$n=getTotalAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'reg_05', 'reg_05>', '0', $qryparam, '') ?>
								</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="119" sdnum="1033;">
								<?=$n=getTotalAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'no_mam', 'no_mam>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center">
								<?=$d=getTotalAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'reg_05', 'reg_05>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="10" sdnum="1033;">
								<?=$n=getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_due_list', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center">
								<?=$d=getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'sam_due_list!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="40" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_sex!', '', $qryparam, '') ?>
							</td>
							<td class="header-submain1" data-a-wrap="true" data-b-a-s="thin" data-b-a-c="000000" data-a-h="left" data-a-v="middle" data-f-sz="12">
								<br>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="29" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_sex', 'male', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_sex!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="29" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_sex', 'female', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_sex!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="29" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_del', 'normal', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_del!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="72.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="29" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_del', 'c_sec', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_del!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="29" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_bw>', '2.5', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_sex!', '', $qryparam, '') ?>
							</td>
							...
							<?php for ($i = 0; $i < $m; $i++) {  $qryparam=$fullfilter[$i]; ?>
								...
								<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="72.5" sdnum="1033;0;0.0">
									<?= round((($n * 100) / $d), 0) ?>
								</td>
							<?php  $qryparam=''; } ?>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="186" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_bw<', '2.4', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_sex!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="11" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_bo', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_sex!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="11" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_bo', '2', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_sex!', '', $qryparam, '') ?>
							</td>
							...
							<?php for ($i = 0; $i < $m; $i++) {  $qryparam=$fullfilter[$i]; ?>
								...
								<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
									<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_bo!', '0', $qryparam, '') ?>
								</td>
								<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="27.5" sdnum="1033;0;0.0"><b>
										<?= round((($n * 100) / $d), 0) ?>
									<?php  $qryparam=''; } ?>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="11" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_bo', '3', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_bo!', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="11" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_bo', 'gr_3', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_bo!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="27.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_eibf', 'within_1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_eibf!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_eibf', 'within1_3', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_eibf!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_eibf', 'after_3', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_eibf!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_eibf', 'next_day', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_eibf!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_eibf', 'cant_rem', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_eibf!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf', 'only_bm', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="47.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf', 'bm_fm', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf', 'bm_am', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf', 'bm_water', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf', 'fm', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf', 'am', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf', 'nothing', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_ebf!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="2" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'feed_mode', 'bottle', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="13" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'feed_mode!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'feed_mode', 'tumbler', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'feed_mode!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="19" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'feed_mode', 'katori_c', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'feed_mode!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="9" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'support_bf__aww', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'support_bf__aww>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="22.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="1" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'support_bf__anm', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'support_bf__anm>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="2.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="9" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'support_bf__asha', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'support_bf__asha>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="22.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="0" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'support_bf__no_supp', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'support_bf__no_supp>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="0" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="14" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_gm_records_pt', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_gm_records_pt!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="5" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_gm_records_mcp', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_gm_records_mcp!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="12.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="12" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_caregiver_aware_ns', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_caregiver_aware_ns!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="30" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b></td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit', '0', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit', '2', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit', '3', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit', '4', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit', '5', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_aww_visit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit', '0', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit>', '0', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="520" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit', '1', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit', '2', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit', '3', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit', '4', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="208" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit', '5', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'infant_asha_visit>', '0', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="40" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_sex!', '', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_sex!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="520" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="23" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_sex', 'male', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_sex!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="23" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_sex', 'female', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_sex!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="37" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_hw_coun_health_clean', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_hw_coun_health_clean!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="37" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'attended_ann', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'attended_ann!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="92.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="37" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_wm_last_m', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_wm_last_m!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="92.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="37" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_hl_m', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'child_hl_m!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="92.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="37" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_informed_cns', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'aww_informed_cns!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="92.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="37" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'cf_started_68', 'yes', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'cf_started_68!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="92.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="37" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'food_freq_68', 'one', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'food_freq_68!', '', $qryparam, '') ?>
							</td>
							<td class="td_head thead" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-fill-color="C5D9F1" data-a-h="center" sdval="92.5" sdnum="1033;0;0.0"><b>
									<?= round((($n * 100) / $d), 0) ?>
								</b>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="37" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'food_freq_68', 'two', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'food_freq_68!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="37" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'food_freq_68', 'three', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'food_freq_68!', '', $qryparam, '') ?>
							</td>
						...
						<tr>
							...
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" bgcolor="#FFFFFF" sdval="37" sdnum="1033;">
								<?= $n = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'food_freq_68', 'zero', $qryparam, '') ?>
							</td>
							<td class="td_head" data-b-a-s="thin" data-b-a-c="000000" data-f-bold="true" data-a-h="center" sdval="40" sdnum="1033;">
								<?= $d = getcountAWCHV($conn, 'aujyspbgxt8m3j9tjmv62c3', 'id', 'food_freq_68!', '', $qryparam, '') ?>
							</td>

...
function getcountAMB_multies($conn, $tablename, $field, $qryfield, $value, $qryfield1 = '', $value1 = '')
{
   ...
   if (isset($_REQUEST['search'])) {
    ...
    $query = "SELECT  COUNT(*) as total FROM $tablename WHERE $qryfield='$value' AND (signs_anaemia__1 + signs_anaemia__2 + signs_anaemia__3 + signs_anaemia__4 + signs_anaemia__99) >= 2 $qryv $qry";
    $result = mysqli_query($conn, $query);
    $row = mysqli_fetch_object($result);
            ...
            <div class="col-lg-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><i class="fa fa-calandar"></i>Beneficiary Analysis Anaemia</li>
                    </ol>
				...
				<div class="row filter_css clearfix g-1">
					<div class="col-lg-2 col-md-4 col-sm-12">
						<div class="form-group">
							...
							$allDistricts='';
							$selected=''; $kl=1;
							$qryDistrictType = mysqli_query($conn, "SELECT distinct(district) from atxsdfbavqwfhfsuuovusn");
					...
					<div class="col-lg-2 col-md-3 col-sm-12">
						<div class="form-group"> 
							...
							<?php 
							$selected='';
							$qryUserType = mysqli_query($conn,"SELECT DISTINCT type_mon FROM atxsdfbavqwfhfsuuovusn ORDER BY type_mon ASC");
            ...
            <section class="panel p-1">
                <div class="table-responsive">
                    <table id="simpleTable1" data-cols-width="60,50,10">
                        <tr>
                            <td class="header1" style="font-size: 16px;" colspan="5" data-f-sz="16" data-a-h="center" data-fill-color="F2F2F2" data-f-color="800000" data-b-r-s="thick" data-b-r-c="000000" data-b-t-s="thick" data-b-t-c="000000" data-b-b-s="thick" data-b-b-c="0000FF" data-f-bold="true">Beneficiary Anaemia Analysis(District: <?php if($districtText!='') { echo ucwords($districtText); } else { echo $allDistricts; }  ?>) <?php if($first==$last) { ?> <?=date('F-Y',strtotime($last))?> <?php } else { ?> <?=date('F',strtotime($first))?> - <?=date('F Y',strtotime($last))?> <?php } ?></td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3" data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=$Va1g= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'District!', '', '', '') ?> <?php $totReco= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'District!', '', '', '') ?></td>
						...
						<tr data-weight="140">
                            ...
                            <td data-fill-color="F2F2F2"><?=$cat1= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'children__5_9_years', '', '') ?></td>
                            <td data-fill-color="F2F2F2"><?=$V2tot= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type!', '', '', '') ?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$cat2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'adolescents__10_19_years', '', '') ?></td>
						...
						<tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$cat3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'lactating_woman', '', '') ?></td>
                            <td data-fill-color="F2F2F2"><?=$V2tot?></td>
						...
						<tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$cat4= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', '', '') ?></td>
                            <td data-fill-color="F2F2F2"><?=$V2tot?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$cat5= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'women_of_reproductive_age_grou', '', '') ?></td>
                            <td data-fill-color="F2F2F2"><?=$V2tot?></td>
						...
						<tr data-weight="140">
                            ...
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Adolescents (10-19 years)</td>
                            <td data-fill-color="F2F2F2"><?=$as2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'adolescents__10_19_years', '_2_9_Was_your_haemoglobin_teste', 'yes') ?> 
							</td>
						...
						<tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Lactating Woman</td>
                            <td data-fill-color="F2F2F2"><?=$as3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'lactating_woman', '_3_1_Was_your_haemoglobin_teste', 'yes') ?></td>
						...
						<tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Pregnant Woman (2nd / 3rd Trimester)</td>
                            <td data-fill-color="F2F2F2"><?=$as4= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim','_4_1_Was_your_haemoglobin_teste', 'yes') ?></td>
                        ...
                        <tr>
                            <td class="tdhead" data-a-h="right" data-b-b-s="thin" data-b-b-c="0000FF" data-fill-color="F2F2F2">Women of reproductive age group (20-49 years)</td>
                            <td data-fill-color="F2F2F2"><?=$as5= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'women_of_reproductive_age_grou', '_5_9_Was_your_haemoglobin_teste', 'yes') ?></td>
						...
						<tr data-weight="140">
                            ...
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Adolescents (10-19 years)</td>
                            <td data-fill-color="F2F2F2"><?=$af2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'adolescents__10_19_years', '_2_1_Did_you_receive_IFA_Tablet', 'yes') ?></td>
							</td>
                            <td data-fill-color="F2F2F2"><?=$cat2?></td>
						...
						<tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Lactating Woman</td>
                            <td data-fill-color="F2F2F2"><?=$af3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'lactating_woman', '_3_12_Did_you_receive_IFA_red_t', 'yes') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat3?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($af3)*100)/($cat3)),1),1) ?>%</td>
                        </tr>
						<tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Pregnant Woman (2nd / 3rd Trimester)</td>
                            <td data-fill-color="F2F2F2"><?=$af4= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', '_4_6_Which_of_these_are_you_tak__ifa_red_tablet', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($af4)*100)/($cat4)),1),1) ?>%</td>
                        </tr>
                        <tr>
                            <td class="tdhead" data-a-h="right" data-b-b-s="thin" data-b-b-c="0000FF" data-fill-color="F2F2F2">Women of reproductive age group (20-49 years)</td>
                            <td data-fill-color="F2F2F2"><?=$af5= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'women_of_reproductive_age_grou', '_5_1_Did_you_receive_IFA_Tablet', 'yes') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat5?></td>
						...
						<tr data-weight="140">
                            ...
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Adolescents (10-19 years)</td>
                            <td data-fill-color="F2F2F2"><?=$ias2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'adolescents__10_19_years', '_2_11_Can_respondent_n_symptoms_of_Anemia', 'yes') ?> </td></td>
                            <td data-fill-color="F2F2F2"><?=$cat2?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($ias2)*100)/($cat2)),1),1) ?>%</td>
                        </tr>
						<tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Lactating Woman</td>
                            <td data-fill-color="F2F2F2"><?=$ias3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'lactating_woman', '_3_15_Can_respondent_n_symptoms_of_Anemia', 'yes') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat3?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($ias3)*100)/($cat3)),1),1) ?>%</td>
                        </tr>
						<tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Pregnant Woman (2nd / 3rd Trimester)</td>
                            <td data-fill-color="F2F2F2"><?=$ias4= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', '_4_11_Can_respondent_n_symptoms_of_Anemia', 'yes') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($ias4)*100)/($cat4)),1),1) ?>%</td>
                        </tr>
                        <tr>
                            <td class="tdhead" data-a-h="right" data-b-b-s="thin" data-b-b-c="0000FF" data-fill-color="F2F2F2">Women of reproductive age group (20-49 years)</td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF" ><?=$ias5= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'women_of_reproductive_age_grou', '_5_12_Can_respondent_n_symptoms_of_Anemia', 'yes') ?></td>
						...
						<tr data-weight="140">
                            ...
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Adolescents (10-19 years)</td>
                            <td data-fill-color="F2F2F2"><?=$irf2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'adolescents__10_19_years', '_2_12_Can_the_respond_iron_rich_food_items', 'yes') ?> <?php $V2tot= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', '_2_12_Can_the_respond_iron_rich_food_items!', '', '', '') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat2?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($irf2)*100)/($cat2)),1),1) ?>%</td>
                        </tr>
						<tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Lactating Woman</td>
                            <td data-fill-color="F2F2F2"><?=$irf3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'lactating_woman', '_3_16_Can_the_respond_iron_rich_food_items', 'yes') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat3?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($irf3)*100)/($cat3)),1),1) ?>%</td>
                        </tr>
						<tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Pregnant Woman (2nd / 3rd Trimester)</td>
                            <td data-fill-color="F2F2F2"><?=$irf4= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', '_4_12_Can_the_respond_iron_rich_food_items', 'yes') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($irf4)*100)/($cat4)),1),1) ?>%</td>
                        </tr>
                        <tr>
                            <td class="tdhead" data-a-h="right" data-b-b-s="thin" data-b-b-c="0000FF" data-fill-color="F2F2F2">Women of reproductive age group (20-49 years)</td>
                            <td data-fill-color="F2F2F2"><?=$irf5= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'women_of_reproductive_age_grou', '_5_13_Can_the_respond_iron_rich_food_items', 'yes') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat5?></td>
						...
						<tr data-weight="140">
                            ...
                            <td data-fill-color="F2F2F2"><?=$ha=getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim','heard_anaemia', 'yes') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2 " data-b-b-s="thin" data-b-b-c="0000FF"><?=$sya=getcountAMB_multies($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'signs_anaemia!', '') ?></td>
						...
						<tr data-weight="140">
                            ...
                            <td data-fill-color="F2F2F2"><?=$csa1= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'signs_anaemia__1', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$csa2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'signs_anaemia__2', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$csa3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'signs_anaemia__3', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
						...
						<tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$csa4= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'signs_anaemia__4', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
						...
						<tr>
                            ...
                            <td data-fill-color="F2F2F2"  data-b-b-s="thin" data-b-b-c="0000FF"><?=$csa99= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'signs_anaemia__99', '1') ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$cat4?></td>
						...
						<tr data-weight="140">
                            ...
                            <td data-fill-color="F2F2F2"><?=$idsa1= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'signs_of_anaemia', '4') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
						...
						<tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$idsa5= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'signs_of_anaemia', '5') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$idsa2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'signs_of_anaemia', '3') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$idsa3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'signs_of_anaemia', '2') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
						...
						<tr>
                            ...
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$idsa4= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'signs_of_anaemia', '1') ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$cat4?></td>
						...
						<tr data-weight="140">
                            ...
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$cirfy1= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'consume_iron_rich_food!', '4') ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$cirfa1= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'consume_iron_rich_food!', '') ?></td>
						...
						<tr data-weight="140">
                            ...
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$cirfy= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'consume_ironrich', 'yes') ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$cirfa= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'consume_ironrich!', '') ?></td>
						...
						<tr data-weight="140">
                           ...
                           <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$cirfy2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'prepare_iron_rich_food!', '1') ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$cirfa2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'prepare_iron_rich_food!', '') ?></td>
						...
						<tr data-weight="140">
                           ...
                           <td data-fill-color="F2F2F2"><?=$cirfy3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'avoid_foods', 'yes') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cirfa3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'avoid_foods!', '') ?></td>
						...
						<tr data-weight="140">
                            ...
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$aoifas= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'received_ifa_flw', 'yes') ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$aoifasAll= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'received_ifa_flw!', '') ?></td>
						...
						<tr data-weight="140">
                            ...
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right" data-a-h="right">Tablets not available</td>
                             <td data-fill-color="F2F2F2"><?=$govtTab= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'ifa_tablet_challenges__1', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$govtTabAll= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'ifa_tablet_challenges!', '') ?></td>
                        ...
                        <tr>
                            <td class="tdhead" data-fill-color="F2F2F2" data-a-h="right">Did not go for health checkup at VHSND / Health Facility </td>
                             <td data-fill-color="F2F2F2"><?=$govtTab1= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'ifa_tablet_challenges__2', '1') ?></td>
                        ...
                        <tr>
                            <td class="tdhead" data-a-h="right" data-fill-color="F2F2F2">Health care providers were not available	</td>
                             <td data-fill-color="F2F2F2"><?=$govtTab2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'ifa_tablet_challenges__3', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$govtTabAll?></td>
						...
						<tr>
                            <td class="tdhead" data-a-h="right" data-fill-color="F2F2F2">Others	</td>
                             <td data-fill-color="F2F2F2"><?=$govtTab3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'ifa_tablet_challenges__99', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$govtTabAll?></td>
						...
						<tr data-weight="140">
                            <td style="font-weight: 600; border-bottom: 1px solid black;text-align:left!important;vertical-align:middle;text-align:left!important;vertical-align:middle;" data-b-b-s="thin" data-b-b-c="0000FF" rowspan="1" colspan="2" data-a-v="middle" data-f-bold="true" data-fill-color="F2F2F2">Pregnant Women who took iron supplements during their current or previous pregnancy</td>
                             ...
                             <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$ifaCom= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'take_ifa', 'yes') ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$ifaComALL=getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'take_ifa!', '')?></td>
						...
						<tr data-weight="140">
                            <td style="font-weight: 600; border-bottom: 1px solid black;text-align:left!important;vertical-align:middle;text-align:left!important;vertical-align:middle;" data-b-b-s="thin" data-b-b-c="0000FF" rowspan="1" colspan="2" data-a-v="middle" data-f-bold="true" data-fill-color="F2F2F2">Pregnant women who consumed more than 7 tablets in last 7 days</td>
                             ...
                             <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$ifaCom2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'how_many_ifa>', 7) ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$ifaCom2ALL=getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'how_many_ifa!', '')?></td>
						...
						<tr data-weight="140">
                            <td style="font-weight: 600; border-bottom: 1px solid black;text-align:left!important;vertical-align:middle;text-align:left!important;vertical-align:middle;" data-b-b-s="thin" data-b-b-c="0000FF" rowspan="1" colspan="2" data-a-v="middle" data-f-bold="true" data-fill-color="F2F2F2">Pregnant Women willing to buy and consume iron tablets in the absence of government distribution</td>
                             ...
                             <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$Rpai= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'would_you_buy_ifa', 'yes') ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$RpaiALL=getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'would_you_buy_ifa!', '')?></td>
						...
						<tr data-weight="140">
                            <td style="font-weight: 600; border-bottom: 1px solid black;text-align:left!important;vertical-align:middle;text-align:left!important;vertical-align:middle;" data-b-b-s="thin" data-b-b-c="0000FF" rowspan="1" colspan="2" data-a-v="middle" data-f-bold="true" data-fill-color="F2F2F2">Pregnant Women who experienced side effects after taking iron supplements</td>
                             ...
                             <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$ACai= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'experienced_side_effects', 'yes') ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$ACaiALL=getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'experienced_side_effects!', '')?></td>
						...
						<tr data-weight="140">
                           ...
                           <td data-fill-color="F2F2F2"><?=$rsideEfect1= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'experienced_side_effects_details__1', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$rsideEfectALL=getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'experienced_side_effects', 'yes')?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$rsideEfect2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'experienced_side_effects_details__2', '1') ?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$rsideEfect3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'experienced_side_effects_details__3', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$rsideEfectALL?></td>
						 ...
						 <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$rsideEfect4= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'experienced_side_effects_details__4', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$rsideEfectALL?></td>
						...
						<tr>
                            ...
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$rsideEfect99= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'experienced_side_effects_details__99', '1') ?></td>
						...
						<tr data-weight="140">
                            ...
                            <td data-fill-color="F2F2F2"><?=$soiAne1= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'info_anaemia__1', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$soiAne2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'info_anaemia__2', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$soiAne3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'info_anaemia__3', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
						 ...
						 <tr>
                           ...
                           <td data-fill-color="F2F2F2"><?=$soiAne4= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'info_anaemia__4', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                            <td data-fill-color="F2F2F2" data-b-r-s="thick" data-b-r-c="0000FF"><?=number_format(round(((($soiAne4)*100)/($cat4)),1),1) ?>%</td>
                        </tr>
						<tr>
                            <td class="tdhead" data-a-h="right" data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF">Others	</td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$soiAne99= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'info_anaemia__99', '1') ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$cat4?></td>
						...
						<tr data-weight="140">
                            ...
                            <td data-fill-color="F2F2F2"><?=$anemeaPrev1= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'info_healthy_diet_whom__1', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$anemeaPrev2= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'info_healthy_diet_whom__2', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
                        ...
                        <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$anemeaPrev3= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'info_healthy_diet_whom__3', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
						 ...
						 <tr>
                            ...
                            <td data-fill-color="F2F2F2"><?=$anemeaPrev4= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'info_healthy_diet_whom__4', '1') ?></td>
                            <td data-fill-color="F2F2F2"><?=$cat4?></td>
						...
						<tr>
                            ...
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$anemeaPrev99= getcountAMB($conn, 'atxsdfbavqwfhfsuuovusn', 'id', 'Beneficiary_type', 'pregnant_woman__2nd___3rd_trim', 'info_healthy_diet_whom__99', '1') ?></td>
                            <td data-fill-color="F2F2F2" data-b-b-s="thin" data-b-b-c="0000FF"><?=$cat4?></td>

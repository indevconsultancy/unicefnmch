...
function generateForIndicator1($conn,$facility,$qry,$chkService,$monthYear) {
...
function generateForIndicator2($conn,$facility,$qry,$chkService,$monthYear) {
...
function generateForIndicator3($conn,$facility,$qry,$chkService,$monthYear) {
...
function generateForIndicator4($conn,$facility,$qry,$chkService,$monthYear) {
...
function generateForIndicator41($conn,$facility,$qry,$chkService,$monthYear) {
...
function generateForIndicator5($conn,$facility,$qry,$chkService,$monthYear) {
...
function generateForIndicator6($conn,$facility,$qry,$chkService,$monthYear) {
                        	...
                        	if($_REQUEST['uType']!='')
					{
						...
						while ($dataAWCvisit = mysqli_fetch_object($sqlAWCvisit)) { 
							...
							$tablevalues.=' <tr>
								...
								{
									for ($k = 0; $k < $m; $k++) {
									$tablevalues.=generateForIndicator1($conn,$dataAWCvisit->hf_name,$qry,$chkService,$fullfilter[$k]);
									}
								}
								...
								{								
									////////////////////////////
									for ($k = 0; $k < $m; $k++) {
									$tablevalues.=generateForIndicator2($conn,$dataAWCvisit->hf_name,$qry,$chkService,$fullfilter[$k]);
									}
								}
									/////////////////////////////
								...
								{
									for ($k = 0; $k < $m; $k++) {
									$tablevalues.=generateForIndicator3($conn,$dataAWCvisit->hf_name,$qry,$chkService,$fullfilter[$k]);
									}
								...
								{	
									////////////////////////////////
									for ($k = 0; $k < $m; $k++) {
									$tablevalues.=generateForIndicator4($conn,$dataAWCvisit->hf_name,$qry,$chkService,$fullfilter[$k]);
									}
								}
								...
								{
									for ($k = 0; $k < $m; $k++) {
									$tablevalues.=generateForIndicator5($conn,$dataAWCvisit->hf_name,$qry,$chkService,$fullfilter[$k]);
									}
									///////////////////////////////////////
								...
								{
									for ($k = 0; $k < $m; $k++) {
									$tablevalues.=generateForIndicator6($conn,$dataAWCvisit->hf_name,$qry,$chkService,$fullfilter[$k]);
									}
									///////////////////////////////////
...
<section id="main-content">
 ...
 <?php } ?>
 <?php if($_REQUEST['uType']!='') { 
 if($_REQUEST['uType']=='Doses') {  $colspanss=4+($m*3); } 
 else {  $colspanss=4+($m*2); }

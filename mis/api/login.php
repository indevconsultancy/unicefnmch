    ...
    if ($count > 0) {
        ...
        if (password_verify($user_password, $data->password)) {
			...
			*/
            ...
            $url_logo = "https://unicef.indevconsultancy.com/logo_image/" . $logo_image . "";

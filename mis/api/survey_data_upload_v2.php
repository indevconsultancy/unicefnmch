...
function Profile1($conn, $clientId = 1)
{
	...
	*/
	  $full_json = json_encode($encrypted_array, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
	  $full_json =str_replace("'","",$full_json);
	  $full_json =str_replace("\\","-",$full_json);
	  $_REQUEST=json_decode($full_json,true);
    ...
    $sequence_unique_id=$_REQUEST['sequence_unique_id'];
	...
	if ($details_survey->tot > 0) {
		...
		if ($json != '' && !empty($survey_id)) {
			...
			if ($details_survey->tot > 0) {
				...
				$inser_sql = "update survey_data_monitoring set created_on='".$created_on."', survey_data_json='" . $json . "', full_json='" . $full_json_encrypted . "',survey_status='" . $survey_status . "', cluster_code='" . $cluster_no . "', user_type='" . $user_type . "', termination_reason='" . $termination_reason . "',description='".$description."', hint_record='" . $hintques . "', error_record='" . $error_record . "', para_data='" . $paradatas . "',survey_data_json_coded='" . $jsonCoded . "' where survey_id='" . $survey_id . "' and user_id='" . $user_id . "'  ";
			   ...
			   $inser_sql = "insert into survey_data_monitoring set survey_id='" . $survey_id . "',survey_data_id='" . $sequence_unique_id . "',user_id='" . $user_id . "',survey_data_json='" . $json . "',survey_data_json_coded='" . $jsonCoded . "', full_json='" . $full_json_encrypted . "',cluster_code='" . $cluster_no . "',survey_status='" . $survey_status . "',user_type='" . $user_type . "',termination_reason='" . $termination_reason . "',description='".$description."',survey_name='" . $survey_name . "', survey_name_id='" . $survey_name_id . "', client_id='" . $client_id . "', latitude='" . $GPS_lat . "', longitude='" . $GPS_long . "', created_on='" . $created_on . "', hint_record='" . $hintques . "', error_record='" . $error_record . "', para_data='" . $paradatas . "',language_id='" . $selected_language . "' ";
				$insertquery = mysqli_query($conn, $inser_sql);

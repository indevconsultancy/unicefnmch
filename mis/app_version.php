				...
				<div class="container-fluid">
					<form class="form-inline" action="" method="GET">
						...
						<div class="row filter_css clearfix">
							<div class="col-lg-4" style="margin-bottom: 1rem!important;">
								...
								if (mysqli_num_rows($qryAppVersion) > 0) {
									while ($row = mysqli_fetch_array($qryAppVersion)) {
										...
										<tr>
											...
											<td>
											<span class="label label-success" data-bs-toggle="tooltip"data-bs-html="true" data-bs-placement="top" title="App Version </br> Device: <?=$device_name?> </br> OS Version: <?=$os_version?> "> v<?=$app_version;?></span> 

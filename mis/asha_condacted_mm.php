...
<?php define("title", "Asha Conducted MM & HELD"); ?>
...
<section id="main-content">
    <section class="wrapper">
            ...
            <div class="col-lg-12" style="background-color:rgb(238, 142, 7);">
                <nav aria-label="breadcrumb ">
                    <ol class="breadcrumb mb-0 py-2">
                        ...
                        <li class="breadcrumb-item"><i class="fa fa-calandar"></i>Asha Conducted MM & HELD</li>
                    </ol>
        ...
        <form action="?" method="get" class="row g-3 justify-content-center m-3">
            ...
            <div class="col-md-2 d-flex align-items-end">
                <a href="asha_condacted_mm.php" type="reset" class="btn btn-danger w-100">Reset</a>
            </div>
            ...
            <div class="table-responsive">
                <table id="simpleTable1">
                    ...
                    <tr style="position: sticky; top: 0; background: #2c1ea5; z-index: 1; height: 40px;">
                        <td class="header1" style="font-size: 20px; color:#FFFFFF!important;" colspan="<?= $totalMonthss+3 ?>" data-f-sz="20" data-a-h="center" data-fill-color="2c1ea5" data-f-color="FFFFFF" data-b-r-s="thick" data-b-r-c="000000" data-b-t-s="thick" data-b-t-c="000000" data-f-bold="true"><b>Asha Conducted MM & HELD</b></td>
                    </tr>
                    <!-- Second Header -->
                    <tr>
                    ...
                    <tr style="background-color: #FFF9C4;">
                        ...
                        <td style="text-align: left;" data-f-bold='true' data-fill-color='FFF9C4' data-b-a-s='thin' data-b-a-c='000000'>Number of ASHA</td>
                        <?php
                        if (!(isset($_GET['fromDate']) && isset($_GET['toDate']))) {
                            echo monthly_summary_row($conn,'total_nos_asha','01-01-2024', '01-12-2024'); 
                        } else {
                            echo monthly_summary_row($conn,'total_nos_asha',$_GET['fromDate'], $_GET['toDate']); 
                        }
                        ?>
                    </tr>
                    ...
                    <tr style="background-color: #FFF9C4;">
                        ...
                        <td style="text-align: left;" data-f-bold='true' data-fill-color='FFF9C4' data-b-a-s='thin' data-b-a-c='000000' >No. of ASHA Conducted mothers meeting in the month</td>
                        <?php
                        if (!(isset($_GET['fromDate']) && isset($_GET['toDate']))) {
                            echo monthly_summary_row($conn,'ashas_conducted_meetings','01-01-2024', '01-12-2024'); 
                        } else {
                            echo monthly_summary_row($conn,'ashas_conducted_meetings',$_GET['fromDate'], $_GET['toDate']); 
                        }
                        ?>
                    </tr>
                    ...
                    <tr style="background-color: #FFF9C4;">
                        ...
                        <td style="text-align: left;" data-f-bold='true' data-fill-color='FFF9C4' data-b-a-s='thin' data-b-a-c='000000'>%age of ASHA Conducted mothers meeting</td>
                        <?php
                        if (!(isset($_GET['fromDate']) && isset($_GET['toDate']))) {
                            echo monthly_percentage_row($conn, 'ashas_conducted_meetings', 'total_nos_asha','01-01-2024', '01-12-2024');
                        } else {
                            echo monthly_percentage_row($conn, 'ashas_conducted_meetings', 'total_nos_asha',$_GET['fromDate'], $_GET['toDate']);
                        }
                        ?>
                    </tr>
                    ...
                    <tr style="background-color: #FFF9C4;">
                        ...
                        <td style="text-align: left;" data-f-bold='true' data-fill-color='FFF9C4' data-b-a-s='thin' data-b-a-c='000000'> Number of Mother Meeting to be held by Asha</td>
                        <?php
                        if (!(isset($_GET['fromDate']) && isset($_GET['toDate']))) {
                    ...
                    <tr style="background-color: #FFF9C4;">
                        <td data-f-bold='true' data-fill-color='FFF9C4' data-b-a-s='thin' data-b-a-c='000000' style="background-color: #FFF9C4;">5</td>
                        <td style="text-align: left;" data-f-bold='true' data-fill-color='FFF9C4' data-b-a-s='thin' data-b-a-c='000000'> Number of Mother Meeting held by Asha</td>
                        <?php
                        if (!(isset($_GET['fromDate']) && isset($_GET['toDate']))) {
                    ...
                    <tr style="background-color: #FFF9C4;">
                        <td data-f-bold='true' data-fill-color='FFF9C4' data-b-a-s='thin' data-b-a-c='000000' style="background-color: #FFF9C4;">6</td>
                        <td style="text-align: left;" data-f-bold='true' data-fill-color='FFF9C4' data-b-a-s='thin' data-b-a-c='000000'>% age mothers meeting Heald </td>
                        <?php
                        if (!(isset($_GET['fromDate']) && isset($_GET['toDate']))) {
                            echo monthly_percentage_row($conn, 'mothers_meetings_held', 'mothers_participated_meeting','01-01-2024','01-12-2024');
                        } else {
                            echo monthly_percentage_row($conn, 'mothers_meetings_held', 'mothers_participated_meeting',$_GET['fromDate'], $_GET['toDate']);
                        }
                        ?>
                    </tr>
                </table>
...
<SCRIPT>
    ...
    button.addEventListener("click", (e) => {
        ...
        TableToExcel.convert(table, {
            name: "Asha Conducted MM & HELD.xlsx", // Set your desired file name here
            sheet: {
                name: "Asha Conducted MM & HELD" // Set the sheet name here
            }
        });
    });
</SCRIPT>

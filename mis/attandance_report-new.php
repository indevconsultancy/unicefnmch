				...
				<div class="col-sm-12">
					...
					<section class="panel p-1">
						...
						<?php
							...
							$usersStmt = mysqli_query($conn,"SELECT DISTINCT monitor_name FROM survey_data_monitoring where 1=1 and monitor_name not in('Dr.Mohit Bhardwaj','Dr Deepika Agrawal','GAGAN GAUTAM','DC','Murgibigha') $qry $qry1 ORDER BY monitor_name ASC");
							$userRows=mysqli_num_rows($usersStmt);
							$colspan=2;
							if($userRows>0)
							{
								$colspan=($userRows*2)+3;
							}
							$userslist=array();
							...
							echo "<tr><th data-f-bold='true' data-f-sz='12' data-fill-color='9fd9ef' data-f-color='000000' style='background-color: #9fd9ef !important; color: #000 !important; border-right: black 2px solid; border-bottom: black 2px solid;' rowspan='2'>Date</th>";
							$althead='';
							while($users = mysqli_fetch_object($usersStmt))
							{
								$userslist[]=$users->monitor_name;
								echo "<th data-f-bold='true' data-f-sz='12' data-fill-color='9fd9ef' colspan='2' data-f-color='000000' data-text-center='true' data-vertical-align='middle' style='background-color: #9fd9ef !important; color: #000 !important; border-right: black 2px solid; '>".ucwords($users->monitor_name)."</th>";
								
								$althead.="<th data-f-bold='true' data-f-sz='12' data-fill-color='9fd9ef'  data-f-color='000000' data-text-center='true' data-vertical-align='middle' style='background-color: #9fd9ef !important; color: #000 !important; border-bottom: black 2px solid;'>LF</th>
								
								<th data-f-bold='true' data-f-sz='12' data-fill-color='9fd9ef'  data-f-color='000000' data-text-center='true' data-vertical-align='middle' style='background-color: #9fd9ef !important; color: #000 !important; border-right: black 2px solid; border-bottom: black 2px solid; '>SF</th>";
							}
							echo "<th data-f-bold='true' data-f-sz='12' data-fill-color='9fd9ef' colspan='2' rowspan='2' data-f-color='000000' data-text-center='true' data-vertical-align='middle' style='background-color: #9fd9ef !important; color: #000 !important; border-right: black 2px solid; border-bottom: black 2px solid;'>Total</th>";
							echo "</tr><tr>";
							...
							//for ($day =1;  $day<=$numDays; $day++) { 
								...
								echo "<tr>";
								echo "<td width='10%' style='border-right: black 2px solid;'>" . date('d-M-Y',strtotime($dates)) . "</td>"; // Display the current date
								$i=0;
								...
								foreach($userslist as $usersl)
								   ...
								   //echo "SELECT count(*) as total_survey FROM survey_data_monitoring WHERE monitor_name = '".$usersl."' AND date(visit_date) ='".$dates."' $qry ";
									$stmt = mysqli_query($conn,"SELECT count(*) as total_survey FROM survey_data_monitoring WHERE survey_name_id in(19,20,21,24) and monitor_name = '".$usersl."' AND date(visit_date) ='".$dates."' $qry ");
									$attendance = mysqli_fetch_object($stmt);
									
									$stmtS = mysqli_query($conn,"SELECT count(*) as total_survey FROM survey_data_monitoring WHERE survey_name_id in(27) and monitor_name = '".$usersl."' AND date(visit_date) ='".$dates."' $qry ");
									$attendanceS = mysqli_fetch_object($stmtS);
									...
									if($attendanceS->total_survey>0)
									{
									$usersTotal1S[$i]=$usersTotal1S[$i]+1;
									}
									else {
										$usersTotal1S[$i]=$usersTotal1S[$i]+0;
									}
									
									$usersTotal[$i]=$usersTotal[$i]+$attendance->total_survey;
									$usersTotalS[$i]=$usersTotalS[$i]+$attendanceS->total_survey;
									
									$dayTotal=$dayTotal+$attendance->total_survey;
									$dayTotalS=$dayTotalS+$attendanceS->total_survey;
									if ($attendance->total_survey>0) {
									...
									if ($attendanceS->total_survey>0) {
										if($attendanceS->total_survey>=3)
										{
											$colorS='#369506';
											$color1S='369506';
										}
										else if($attendanceS->total_survey>=2)
										{
											$colorS='#56e21c';
											$color1S='56e21c';
										}
										...
										echo "<td data-f-bold='true' data-text-center='true' data-vertical-align='middle' data-f-sz='12' data-fill-color='".$color1S."' data-f-color='000000' style='text-align:center; vertical-align:middle; background-color:".$colorS."; font-weight:bold; border-right: black 2px solid;'>" . $attendanceS->total_survey."</td>";
									} else {
										echo "<td style='text-align:center; border-right: black 2px solid;' data-text-center='true' data-vertical-align='middle'>-</td>"; // Empty values for no data
									}
								...
								echo "<td  data-f-sz='12' data-text-center='true' data-vertical-align='middle' data-fill-color='9fd9ef' data-f-color='000000' style='background-color: #9fd9ef !important; color: #000 !important; text-align:center;  font-weight:bold; border-right: black 2px solid;'>".$dayTotalS."</td>";
							}
							echo "<tr>";
							echo "<td   data-f-sz='12' data-text-center='true' data-vertical-align='middle' data-fill-color='9fd9ef' data-f-color='000000' style='background-color: #9fd9ef !important; color: #000 !important; font-weight:bold; text-align:center; border-right: black 2px solid;'>Total</td>";
							$ck=0;
							foreach($usersTotal as $allTot)
							{
								...
								echo "<td   data-f-sz='12' data-text-center='true' data-vertical-align='middle' data-fill-color='9fd9ef' data-f-color='000000' style='background-color: #9fd9ef !important; color: #000 !important; text-align:center;  font-weight:bold; border-right: black 2px solid;'>".$usersTotalS[$ck]."</td>";
								$ck++;
							}
							...
							echo "<td   data-f-sz='12' data-text-center='true' data-vertical-align='middle' data-fill-color='9fd9ef' data-f-color='000000' style='background-color: #9fd9ef; color: #000 !important; text-align:center;  font-weight:bold;  border-right: black 2px solid;'>".array_sum($usersTotalS)."</td>";
							echo "</tr>";
							$allTototal=0;
							$allTototalS=0;
							echo "<tr>";
							...
							foreach($usersTotal1 as $allTot1)
							{
								...
								$allTototalS=$allTototalS+$usersTotalS[$nk];
								echo "<td  data-f-sz='12' data-text-center='true' colspan='2' data-vertical-align='middle' data-fill-color='f47c20' data-f-color='000000' style='background-color: #f47c20 !important; vertical-align:middle; color: #000 !important; text-align:center;  font-weight:bold;'>".$allTot1."</td>";
								$nk++;
							}
							echo "<td  data-f-sz='12' data-text-center='true' data-vertical-align='middle' data-fill-color='f47c20' data-f-color='000000' style='background-color: #f47c20 !important; color: #000 !important; vertical-align:middle; text-align:center;  font-weight:bold;' colspan='2'>".$allTototal."</td>";
							echo "</tr>";

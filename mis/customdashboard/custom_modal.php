...
<div class="modal fade" id="chartCustomiseModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-bs-backdrop="static">
	<div class="modal-dialog modal-dialog-centered" style="max-width: 95%;">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" style="font-weight: 500 !important;" id="exampleModalLabel">Graph Customization</h4>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>

			<!-- Modal body -->
			<div class="modal-body">
				<div class="container mt-3" style="height: 450px; ">
					<div class="row">
						<div class="col-sm-5">
							<div class="panel actions">
								<header class="panel-heading tab-bg-primary">
									<ul class="nav nav-tabs">
										<li class="nav-item">
											<a class="nav-link active" data-bs-toggle="tab" href="#v-tabs-home">Titles</a>
										</li>
										<!--
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#v-tabs-profile">Generals</a>
										</li>
										-->
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#v-tabs-messages">Appearance</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#axes">Axes</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#value-labels">Value Labels</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#legend">Legend</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#tooltip">Tooltip</a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-bs-toggle="tab" href="#exporting">Save</a>
										</li>
										<!--
											<li class="nav-item">
												<a class="nav-link" data-bs-toggle="tab" href="#contact">Advance</a>
											</li>
										-->
									</ul>
								</header>
								...
								<div class="panel-body" style="height: 400px; overflow-y: auto;">
									<div class="tab-content">
									  ...
									  -->
										<div id="v-tabs-messages" class="tab-pane fade">
											<div class="panel mt-3">
												...
												<div class="panel-body p-1">
													<table class="table mb-0">
														...
														<tr>
															<td>
																<select name="" id="appearanceFontSize" class="form-control mb-2">
																	<?php
																	for ($i = 2; $i <= 34; $i += 2) {
											...
											<div class="panel mt-3">
												...
												<div class="panel-body p-1">
													<table class="table mb-0" id="addSeriesColor">
														<tr>
													...
													<div class="text-end">
													<button class="btn btn-dark btn-sm  addMoreSeriesColor">+</button>
													</div>
										...
										<div id="axes" class="tab-pane fade">
											<div class="panel mt-3">
											...
											<div class="panel mt-3">
												...
												<div class="panel-body p-1">
													<table class="table mb-0">
														...
														<tr>
															<td>
																<select name="" id="xAxesFontSize" class="form-control mb-2">
																	<?php
																	for ($i = 2; $i <= 34; $i += 2) {
																		echo '<option value="' . $i . 'px">' . $i . '</option>';
																	}
											...
											<div class="panel mt-3">
												...
												<div class="panel-body p-1">
													<table class="table mb-0">
														...
														<tr>
															<td>
																<select name="" id="yAxesFontSize" class="form-control mb-2">
																	<?php
																	for ($i = 2; $i <= 34; $i += 2) {
																		echo '<option value="' . $i . 'px">' . $i . '</option>';
																	}
										...
										<div id="value-labels" class="tab-pane fade">
											<div class="panel mt-3">
										...
										<div id="legend" class="tab-pane fade">
											<div class="panel mt-3">
											...
											<div class="panel mt-3">
												...
												<div class="panel-body p-1">
													<table class="table mb-0">
														...
														<tr>
															<td>
																<select name="" id="legendAppFontSize" class="form-control mb-2">
																	<?php
																	for ($i = 2; $i <= 34; $i += 2) {
																		echo '<option value="' . $i . 'px">' . $i . '</option>';
																	}
										...
										<div id="tooltip" class="tab-pane fade">
											<div class="panel mt-3">
												<div class="panel-heading">General</div>
												<div class="panel-body p-1">
													<table class="table mb-0">
										...
										<div id="exporting" class="tab-pane fade">
											<div class="panel mt-3">

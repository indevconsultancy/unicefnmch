			...
			<div class="col-lg-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb mb-0">
						<li class="breadcrumb-item"><i class="fa fa-list"></i>List Dataset(s)</li>
						<li class="breadcrumb-item active" aria-current="page"><i class="fa fa-eye"></i></i>View Dataset(s)</li>
					</ol>
				</nav>
			</div>
		</div>
		<section class="section-box mb-3 px-4">
							...
							<div class="row">
								...
								<div class=" col-sm-10">
									<p class="text-dark"> <?php $typeofstudy = $dataset['type_of_study_id'];
															echo getcotegryname($conn, 'study_types', 'study_type_id', $typeofstudy, 'study_name')
															?>
									</p>
								</div>
							</div>
				...
				<div class=" mb-3">
					...
					<div class="col-md-12 mt-3">
						<ul class="nav nav-tabs">
							<li class="nav-item">
								<a class="nav-link active" data-bs-toggle="tab" href="#home">File(s)</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-bs-toggle="tab" href="#profile">Metadata</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-bs-toggle="tab" href="#messages">Terms</a>
							</li>
						</ul>
										...
										<table class="table table-striped">
											<thead>
												<tr style="background: #394a59;">
													<th class="cls" style="width: 3%">S.No</th>
													<th class="cls" style="width: 20%">Title</th>
													<th class="cls" style="width: 12%">Data Access</th>
													<th class="cls" style="width: 15%">File Format</th>
													<th class="cls" style="width: 25%">Action </th>
												</tr>
											</thead>
											<?php
											...
											?>
													<tbody>
														<tr class="content">
															...
															<td>
																<?= $user['dataformat_name'] ?>
																<?php
																$Dataid = "D" . $datasetId;

																$file_path = "../upload_data_file/dataset/" . $Dataid . "/" . $user['dataformat_fie'];
																if (file_exists($file_path)) {
																	$file_size = filesize($file_path);
																	echo $datasize = formatBytes($file_size);
																}
																?>
															</td>
															<td>
																...
																<a href="<?php echo $locationC . $user['dataformat_fie']; ?>" download="" class="btn btn-primary btn py-1" data-bs-toggle="tooltip" data-bs-placement="top" title="Download File">
																	<i class="fa fa-download" aria-hidden="true"></i>
																</a>

																<?php if ($_SESSION['user_id'] == $user['user_id']) { ?>
																	<a href="" data-id="<?= $user['dataformat_file_id'] ?>" class="btn btn-primary btn py-1 delRepository" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete File">
																		<i class="fa fa-trash" aria-hidden="true"></i>
																	</a>
																<?php } ?>

																<?php if ($user['sync_status'] == '0' && $dataset['dataset_status'] == 1 && $_SESSION['user_id'] == $user['user_id']) { ?>
																	<a href="javascript:void(0);" data-id="<?= htmlspecialchars($user['dataformat_file_id'], ENT_QUOTES, 'UTF-8') ?>" class="btn btn-primary btn py-1 btn-sync" data-bs-toggle="tooltip" data-bs-placement="top" title="Sync to Dataverse">
																...
																<?php if ($_SESSION['role_id'] == '1') { ?>
																	<?php if ($data_status == '1') { ?>
																		<a type="submit" class="btn btn-primary btn py-1 text-white" disabled data-bs-toggle="tooltip" data-bs-placement="top" title="Approved">
																			<i class="fa fa-check-circle" aria-hidden="true" style="font-size:15px"></i>
																		</a>
																	<?php } else if ($data_status == '0') { ?>
																		<a href="javascript:void(0);" data-id="<?= $user['dataformat_file_id'] ?>" class="btn btn-primary btn py-1 btn-sm approveRepository" data-bs-toggle="tooltip" data-bs-placement="top" title="Approve File">
																			<i class="fa fa-check-circle" aria-hidden="true" style="font-size:15px"></i>
																		</a>
																	<?php } ?>
																	<?php if ($data_status == '2') { ?>
																		<a type="submit" class="btn btn-primary btn py-1 text-white" disabled data-bs-toggle="tooltip" data-bs-placement="top" title="Rejected">
																			<i class="fa fa-times-circle" style="font-size:15px"></i>
																		</a>
																		<a href="javascript:void(0);" data-id="<?= $user['dataformat_file_id'] ?>" class="btn btn-primary btn py-1 approveRepository" data-bs-toggle="tooltip" data-bs-placement="top" title="Approve File">
																			<i class="fa fa-check-circle" aria-hidden="true" style="font-size:15px"></i>
																		</a>
																	<?php } else { ?>
																		<a href="javascript:void(0);" data-id="<?= $user['dataformat_file_id'] ?>" class="btn btn-primary btn py-1 rejectRepository" data-bs-toggle="tooltip" data-bs-placement="top" title="Reject File">
																			<i class="fa fa-times-circle" style="font-size:15px"></i>
																		</a>
																	<?php } ?>
																<?php } ?>
											...
											<tr class="content">
												...
												<td>
													...
													<?php if ($user['sync_status'] == '0') { ?>
														<a href="javascript:void(0);" data-id="<?= htmlspecialchars($user['dataformat_file_id'], ENT_QUOTES, 'UTF-8') ?>" class="btn-sync" data-bs-toggle="tooltip" data-bs-placement="top" title="Sync to Dataverse">
															<i class="fa fa-refresh" aria-hidden="true"></i>
														</a>
													<?php } ?>

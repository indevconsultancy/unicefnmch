			...
			<div class="col-lg-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page"><i class="fa fa-bar-chart"></i></i>Show Dataset(s)</li>
						<li class="breadcrumb-item active" aria-current="page"></i></i>Total Dataset(s): <?= $total_record ?>
						...
						<div class="row g-2">
							<div class="col-sm-4">
								<div class="search-widget">
									<input id="inputDataverseSearch" class="form-control" aria-label="Search all data" placeholder="Title" name="title" value="">
								</div>
							</div>
							<div class="col-sm-2">
							...
							<div class="col-md-12  ">
								...
								?>
										<div class="survey-box">
											...
											<div class="survey-container">
												<div class="survey-heading">
													<p></i> Institution/Organization(s):</p>
												</div>
												<div class="survey-data">
													<p>
														<?php
											...
											<?php if ($_SESSION['user_id'] == $dataset_row['user_id']) { ?>
									...
									<div class="side-data">
										<ul>
											...
											while ($datacategory = mysqli_fetch_array($datassqry)) {
												$sqlcatdata = "SELECT COUNT(dataset_id) as total FROM project_datasets where find_in_set('" . $datacategory['category_id'] . "',thematic_area_id) and project_datasets.status='1' and project_datasets.dataset_status='1'";
											...
											?>
													...
													<li>
														...
														<a href="dataset-list.php?category_id=<?= $datacategory['category_id'] ?>&tool_study_year=&client_name=&searchdata="><span <?php if ($datacategory['category_id'] == $_REQUEST['category_id']) {

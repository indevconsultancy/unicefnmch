...
if (isset($_POST['verify_otp'])) {
	...
	if ($otp == $otp) {
		...
		if ($deleteformsql) {
			...
			$txt = $message_all;
			$subject = base64_encode("Unicef Form Delete");
		...
		<div class="row">
			<div class="col-lg-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><i class="icon_documents_alt"></i>List Form</li>
						<li class="breadcrumb-item" aria-current="page"><i class="fa fa-key" aria-hidden="true"></i>OTP
							Verification</li>
					</ol>
				</nav>
			</div>
			...
			<div class="col-lg-12">
				...
				<section class="panel">
					...
					<div class="panel-body">
						<p>The One Time Password (OTP) has been sent to the verified email address. Please enter it to
							permanently remove the form and associated data from MQUAD server.</p>
						<div class="form">
							<form class="form-validate form-horizontal" method="post" enctype="multipart/form-data">
								<div class="form-group row">
									<label for="cname" class="control-label col-lg-2">OTP: <span

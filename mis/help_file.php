...
<?php define("title", "Help File | FI Data System"); ?>
...
<style>
    ...
    .wrapper .userGuideWrapper .userGuideMain .userGuideNav>div>ul>li>button, .wrapper .userGuideWrapper .userGuideMain .userGuideNav>div>ul>li>a{
        ...
        <div class="userGuideWrapper">
            <div class="userGuideMain">
                <div class="userGuideNav">
                    <div>
                        <ul id="right-nav">
                            <li> <a href="#section1" data-target="section1"> FI Data System </a>
                            </li>
                            <li>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body p-0">
                                                <ul class="p-0">
                                                    <li><a href="#section6" data-target="section6">Purpose of the lookup sheet</a></li>
                                                    <li><a href="#section7" data-target="section7">How to Use</a></li>
                                                    <li><a href="#section8" data-target="section8">Example</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="userGuideContentArea">
                    <div class="header main-top">
                        ...
                        <div class="headerTitle">
                            <h2 class="fw-bold">A Guide to Create Data Collection Form</h2>
                        </div>
                    ...
                    <div>
                        <div class="userGuideArticle">
                            ...
                            <div id="section1" class="container-fluid">
                                ...
                                <h3>Becoming Familiar with FI Data System</h3>

                                <p>FI Data System is a free, effortless, and reliable web interface, wherein one can conduct or organize surveys in an easy manner and yet gain accurate data. An efficient mobile-based application, that lets research organizations, primarily working in development sectors be it the health of a particular bunch of people, nutrition tracking of a certain bunch, governance, or the status of education in a particular area or district,FI Data System is authentic when it comes to conducting surveys & collecting efficient data through electronic means and thus, presenting it using custom statistical widgets with ease. </p>
                            </div>
                            <div id="section2" class="container-fluid">

                                <h3>About FI Data System</h3>

                                <p>FI Data System is a reliable web interface. It facilitates to conduct or organize surveys with ease and collect accurate data. It allows research organizations, primarily working in development sector (health, nutrition, education, etc.) to conduct surveys and collect data through electronic means. Furthermore, it presents data by using custom statistical widgets. </p>
                                <p>It aims to digitize the process of surveys without compromising security and privacy. It assists in customizable dashboard making module to manage the cases effectively. Interestingly, FI Data System works remotely and internationally as well. </p>
                                <p>FI Data System strengthens monitoring anywhere and everywhere it goes. It is a cloud based and knowledge driven system. </p>
                                <h4>Features of FI Data System</h4>
                                <ul class="disk-bullet">
                                    <li>FI Data System provides comprehensive solutions to store, exchange and access tools, questionnaires and data collected as part of FI Data System or otherwise.</li>
                                    ...
                                    <li>It offers support services such as response within 12 hours, demo videos and FI Data System community.</li>
                                </ul>
                            </div>
                            ...
                            <div id="section3" class="container-fluid">
                                ...
                                <p> Steps to design an excel form to upload it on the FI Data System data tool website (https://.FI Data System.org/) for survey generation:

                                    A basic understanding of excel as well as a good understanding of designing a survey questionnaire is required.

                                    Download sample excel file from the FI Data System website (https://FI Data System.org/), the sheets are as follows:

                                    Survey-This sheet comprises all the survey questions along with their corresponding type, label, restrictions, coding, and other instructions which are to be interpreted by the FI Data System server, once uploaded.
                                ...
                                <h5><strong>Download sample excel file from the FI Data System website (https://unicef.indevconsultancy.com/), the sheets are as follows:</strong></h5>
                                <ul>
                                    <li><strong>Survey-</strong>This sheet comprises all the survey questions along with their corresponding type, label, restrictions, coding, and other instructions which are to be interpreted by the FI Data System server, once uploaded.</li>
                                </ul>
                                <ul>
                                ...
                                <div class="table1 table-responsive">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>All questions should be categorized in their respective type for FI Data System to recognize them. The <strong>types</strong> column include free text questions, single/ multiple options , number, date, time ,camera, begin repeat, end repeat, begin group, end group, calculate, audio, video, hidden, note, GPS- button, photos and geographical locations.</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>You can create a <b>unique ID</b> for each survey linked to the responses along with multiple input fields. Write <b>"yes"</b> to all of those questions which are used as a combination.
                                                ...
                                                <p><b> For example:</b> If you want to create a unique id with combination of state code, district code, village code, house no. Write "yes" in this column for all the above questions. Unique id is the reserve keyword for FI Data System application. </p>
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="table5 table-responsive">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>If any question requires any mathematical operation or any other calculation in the response of a question, FI Data System provides an option to calculate. Under this column, you can type calculation steps that are available within FI Data System.

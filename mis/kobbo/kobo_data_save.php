...
$secret_key='aTJQsQcrh8zLMS8BKLc2eb';


$surveySql = mysqli_query($conn, "SELECT id,client_id,user_id,survey_name FROM survey WHERE secret_key = '" . $secret_key . "' ");
...
$survey_name_id = $dataSurvey['id'];

$get_file = file_get_contents("https://unicef.indevconsultancy.in/mis/kobbo/pull-data.php");

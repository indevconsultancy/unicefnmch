			...
			<form method="GET">
				<div class="row">
					...
					<div class="col-lg-3 col-md-2">
						<input type="text" data-bs-placement="top" id="date1" data-bs-toggle="tooltip" data-original-title="From date" class="form-control" title="From date" placeholder="From Date" name="fdate" value="<?php if ($_REQUEST['fdate']) { echo $_REQUEST['fdate']; } ?>">
					</div>
					<div class="col-lg-2 col-md-2">
						<input type="text" data-bs-placement="top" id="date2" data-bs-toggle="tooltip" data-original-title="To date" class="form-control" title="To date" placeholder="To Date" name="tdate" value="<?php if ($_REQUEST['tdate']) { echo $_REQUEST['fdate']; } ?>">
					</div>
					<div class="col-lg-2 col-md-2">

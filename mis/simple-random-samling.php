			...
			<div class="col-lg-12">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item" aria-current="page"><i class="fa fa-window-restore"></i>Simple Random Sampling</li>
					</ol>
				</nav>
			</div>
		</div>
							...
							<form class="form-validate form-horizontal" id="fileupload" method="post" enctype="multipart/form-data">
								...
								<div class="row mb-3">
									<div class="col-lg-offset-2 col-lg-12 text-end">
										<button class="btn btn-primary" type="submit" id="btnUpload" name="submit_data">Submit</button>
										<?= $download; ?>
									</div>
								</div>
							</form>

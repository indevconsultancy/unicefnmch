                                        ...
                                        <div class="form">
                                            <form class="form-validate form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group " id="survey_name">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input class="form-control tooltips" name="structure" id="fileUpload" required accept=".xlsx,.xls," data-bs-placement="top" data-bs-toggle="tooltip"  data-original-title="Are you sure you want to replace the form"  minlength="5" type="file" />

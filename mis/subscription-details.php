			...
			<div class="col-lg-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page"><i class="fa fa-money" aria-hidden="true"></i>Subscription</li>
					</ol>
				</nav>
			</div>
		</div>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-4 col-sm-4  follow-info weather-category">
								...
								//$qrySubscription_status = mysqli_query($conn, "CALL GetSubscriptionDetails($client_id)");
								?>
							...
							<?php if ($role_id == 3) { ?>
								...
								<div class="col-lg-2 col-sm-8 follow-info weather-category">
									...
									<ul>
										<li class="active">
											<i class="fa <?= $iconss ?> fa-2x"></i><br> Subcription <br> <b><?= $textss; ?> <?php //$sssv=subscription_services($conn,$_SESSION['user_id']); print_r($sssv);
																															?></b>
										</li>
									</ul>
								</div>
				...
				<section class="panel">
					<header class="panel-heading tab-bg-info">
						<ul class="nav nav-tabs client-tab">
							<?php if ($role_id == 3) { ?>
								<li class="nav-item">
									<a data-bs-toggle="tab" href="#subscription-history" class="nav-link active">
										Subscription History
									</a>
								</li>
								<li class="nav-item">
									<a data-bs-toggle="tab" href="#profile" class="nav-link">
										Usage History
									</a>
								</li>
							<?php } ?>

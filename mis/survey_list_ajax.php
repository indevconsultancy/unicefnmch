...
<div class="row mb-3">
	<div class="col-md-6"><h4 style="margin: 10px;">Total User(s): <?=$rowCount;?></h4></div>
	...
	<table id="employee_data" style="width:100%;padding: 10px;margin-top: -13px;" class="table table-striped table-bordered display nowrap">
		<thead style=" vertical-align: middle;">
			<tr style="border-width: none !important;">
				<th class="text-center" style="color: #FFFFFF; width: 40px "><input type="checkbox" name="check[]" id="checkAll"> </th>
		...
		<?php
			...
			{ ?>
			<tr>
				<td class="text-center "><input type="checkbox" name="checked_id[]" value="<?=$dataassignUser->user_id;?>"></td>

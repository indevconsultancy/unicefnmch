                             ...
                             while ($survey = mysqli_fetch_array($getSurvey)) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= date('d-M-Y', strtotime($survey['created_at'])); ?></td>
									 <td>
										 <a href="survey-data-list.php?survey_id=<?= $survey['id'] ?>" data-bs-placement="top" data-bs-toggle="tooltip" class="btn-sm btn-primary tooltips" data-original-title="View survey""><i class="fa fa-eye" aria-hidden="true"></i></a>

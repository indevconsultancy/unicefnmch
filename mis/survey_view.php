...
<style>
	...
	.custom-radio label .form-check-input {
			...
			<div class="col-lg-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item" aria-current="page"><i class="fa fa-bars"></i>Form View</li>
					</ol>
				</nav>
			</div>
		</div>
			...
			<div class="col-sm-12">
				<section class="panel">
					<header class="panel-heading">
						Form Name: <?=getonefield($conn, 'survey', 'survey_name', 'id',$_REQUEST['survey_id']); ?>
						<!--<a href="add-question.php?survey_id=<?= $_REQUEST['survey_id'] ?>" class="pull-right btn-sm btn-primary" style="margin: 3px;">Add Item</a> -->
					</header>
					<?php
									...
									<form method="post" enctype="multipart/form-data">
										<div class="row" style="padding: 10px;">
											...
											?>
													...
													<div class="<?= $class =  ($survey['input_field_type'] == 'select_one') ? "col-md-12" : "col-md-12" ?>" style="padding-bottom: 10px;">
														<div class="form-group select-custom-margin">
															<?php
															$is_required = "";
															$is_requiredstr = "";
															if (strtolower($survey['required']) == 'yes') {
																$is_requiredstr = '<span class="required">*</span>';
											...
											?>
											<!--<div class="col-md-12 text-end" style="padding-bottom: 10px;">

...
<section id="main-content">
  <section class="wrapper">
    <div class="add-button-bg">
      <a href="#" class="btn btn-fixed-circle" title="Add Category" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-whatever="@fat" style="border-radius: 40px;">
      ...
      <div class="col-lg-12">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><i class="fa fa-list"></i>List Theme</li>
          </ol>
        </nav>
      </div>
    </div>
              ...
              <div class="col-lg-5"">
                <select class="form-select select2" name="category_id" id="category_id">
                  ...
                  while ($rowCategory = mysqli_fetch_array($categorysql)) { ?>
                    <option value="<?= $rowCategory['category_id'] ?>" <?php if ($rowCategory['category_id'] == @$_REQUEST['category_id']) {
                                                                          echo "selected";
                                                                        } ?>><?= $rowCategory['category_name'] ?></option>
                  <?php } ?>
              ...
              <tbody>
                ...
                while ($user = mysqli_fetch_array($getsql)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="#" class="btn-sm btn-primary" title="Add Category" onclick="return editTheme(<?= $b++; ?>)" data-bs-toggle="modal" data-bs-target="#exampleModalEdit" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-whatever="@fat" style="border-radius: 40px;">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title fw-bold" id="exampleModalLabel" style="color:#394A59;">Theme</h4>
...
<div class="modal fade" id="exampleModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title fw-bold" id="exampleModalLabel" style="color:#394A59;">Edit Theme</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="" method="POST" enctype="multipart/form-data">
        <div class="modal-body">
          <div class="form-group">
            ...
            <select name="category_name" class="ecate form-select">
              <option value="">Select Category</option>
              <?php foreach ($mqcategory as $mqcategorys) { ?>
                <option value="<?= $mqcategorys['category_id'] ?>"><?= $mqcategorys['category_name'] ?></option>
              <?php } ?>

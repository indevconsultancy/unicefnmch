		...
		<div class="col-md-7" style="padding-left: 0px">
			<section class="panel">
				<header class="panel-heading"> 
					...
					<a href="javascript:" data-toggle="modal" data-target="#chartCustomiseModal" class="badge badge-primary customModal" style="float: right; margin-top: 8px;" data-backdrop="static" data-keyboard="false" data-whatever="@fat" >Customise & Save</a>
  ...
  function createChart(chartType,cType=""){
	...
	if(questionFName!=""){
		$.ajax({
		   type: "POST",
		   url: "<?=base_url();?>customdashboard/ssajax.php",
		   data: {chartType:chartType,cType:cType,questionFName:questionFName,surveyId:surveyId,gTitle:gTitle,gquestionFName:gquestionFName,ggTitle:ggTitle,legendColors:legendColors},
		   beforeSend: function() {
			  $("#loading-image").show();
		   },

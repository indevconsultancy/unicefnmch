                        ...
                        <div class="container-fluid">
                            <form class="form-inline" method="get" role="form">
								<div class="row filter_css clearfix">
									...
									<div class="form-group col-lg-3" style="margin-bottom: 1rem!important;">
										<input type="email" class="form-control" name="email"  value="<?=@$_REQUEST['email']?>"placeholder="Email"></input>
									</div>
									<!--<div class="form-group1 col-lg-3" style="margin-bottom: 1rem!important;">
										 <input type="date" data-bs-placement="top" data-bs-toggle="tooltip" class="form-control btn btn tooltips" data-original-title="Form date" placeholder="From Date" name="fdate"value="<?php if ($_REQUEST['fdate']) {echo $_REQUEST['fdate'];} ?>">
									</div>
									<div class="form-group1 col-md-3" style="margin-bottom: 1rem!important;">
									  <input type="date" data-bs-placement="top" data-bs-toggle="tooltip" class="form-control btn btn tooltips" data-original-title="To date" placeholder="To Date" name="tdate"value="<?php if ($_REQUEST['tdate']) {echo $_REQUEST['tdate'];} ?>">
									</div>-->
									<div class="col-lg-3">
										<select class="form-control" name="status" style="margin-bottom: 1rem!important;">
                                ...
                                <tr>
								   ...
								   $functionalsql="SELECT DISTINCT(roles.name) as name FROM `functional_role` INNER join roles on functional_role.role_id=roles.id where functional_role.user_id='".$user['user_id']."'";
									...
									<td>
										<?php
										 if($user['user_status']==1){
											?>
											<a href="user-list.php?active=<?=$user['user_id'];?>" onclick="return confirm('Do you want to Active ?')";  data-bs-placement="top" data-bs-toggle="tooltip" class="btn-sm btn-danger tooltips" data-original-title="Active"><i class="fa fa-times-circle" style="font-size:15px"></i></a>
										<?php		
										 }else{
											 ?>
											   <a href="user-list.php?inactive=<?=$user['user_id'];?>" onclick="return confirm('Do you want to Inctive ?')";  data-bs-placement="top" data-bs-toggle="tooltip" class="btn-sm btn-success tooltips" data-original-title="Inactive"><i class="fa fa-check-circle" aria-hidden="true"  style="font-size:15px"></i></a>
											 <?php
										 }
										 ?>
									</td>
									<td>
										...
										<!--<a href="view-user.php?id=<?=$user['user_id'];?>" data-bs-placement="top" data-bs-toggle="tooltip" class="btn-sm btn-success tooltips" data-original-title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>

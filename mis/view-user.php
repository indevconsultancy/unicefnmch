...
<style>
	...
	.nav-link:hover, .nav-link.active, .nav-link.focused {
		background-color: #449a97 !important;
	}
			...
			<div class="col-lg-12">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb mb-0">
						<li class="breadcrumb-item"><i class="fa fa-list"></i>List Users</li>
						<li class="breadcrumb-item" aria-current="page"><i class="fa fa-eye"></i></i>View User</li>
					</ol>
				</nav>
			</div>
		</div>
				...
				<div class="col-sm-3">
					<div class="card rounded-0 border-0">
						<section class="panel" style="padding:15px;">
							...
							<h4 class="text-secondary"><span style="font-weight: bold; font-size:22px;">Total Collected Data: <?= $count_data['total_survey']; ?></span></h4>
							<hr>
							<div class="profile-usermenu">
								<ul class="nav">
									<li class="w-100">
										<p style="color:#394A59;"><strong>Name: </strong><?= $data['name'] ?></p>
										<hr>
									</li>

									<li class="w-100">
										<p style="color:#394A59;"><strong>Username: </strong><?= $data['username'] ?></p>
										<hr>
									</li>
									<li class="w-100">
										<p style="color:#394A59;"><strong>Functional Type: </strong><?= $fundata['role_name'] ?></p>
										<hr>
									</li>
								</ul>
							</div>
				...
				<div class="col-md-9">
					<div class="profiles-data">
						<ul class="nav nav-tabs">
							<li class="nav-item">
								<a class="nav-link active" data-bs-toggle="tab" href="#home">Collected Form</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" data-bs-toggle="tab" href="#menu1">Assigned Form</a>
							</li>
						</ul>
						<div class="tab-content">
							<div id="home" class="tab-pane fade show active">
								<div class="table-responsive mb-0" id="jar">
									<div class="panel" style="padding:15px;">
											...
											?>
													<tbody>
														<tr class="content">
															...
															<td>
																<!--<a href="view_survey.php?id=<?php //echo $user['survey_data_monitoring_id'];
																								?>" class="btn btn-success btn-sm">View Form</a>-->
										...
										<nav>
											<ul class="pagination1 justify-content-start pagination-sm mt-2">
											</ul>
										</nav>
									</div>
							...
							<div id="menu1" class="tab-pane fade">
								<div class="table-responsive mb-0" id="jar2">
									<div class="panel" style="padding:15px;">
										<!--<h4><strong>Total Record (s): <? php // echo $total_record
																			?></strong></h4>-->
										<table class="table table-striped">
											<thead>
												<tr>
										...
										<nav>
											<ul class="pagination2 justify-content-start pagination-sm mt-2">
											</ul>
										</nav>
									</div>

                                        ...
                                        <div class="form">
                                            <form class="form-validate form-horizontal" method="post" enctype="multipart/form-data">
												...
												<div class="form-group " >
                                                    <label for="ctegoryname" class="control-label col-lg-2">Select Language: <span style="color:red;">*</span></label>    
													<div class="col-lg-10" >
                                                ...
                                                <div class="form-group">
													...
													<button class="btn btn-secondary" type="submit" id="btnUpload"  name="import_data" id="import_data" >Submit</button>
                                                   </div>
                                                </div>
                                            </form>
                                        </div>

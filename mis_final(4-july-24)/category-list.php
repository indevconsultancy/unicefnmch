                ...
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                      <!--  <li><i class="fa fa-home"></i><a href="dashboard.php">Home</a></li> -->
                       ...
                       <li><i class="fa fa-list"></i>Thematic Area	</li>
                    </ol>
                </div>
            </div>
            <!-- page start-->
            <div class="row">
                <div class="col-sm-12">                  
						<div class="container-fluid">
                            <form class="form-inline" method="get" role="form">
								<div class="row filter_css clearfix">
									<div class="form-group col-lg-10" style="margin-bottom: 1rem!important;margin-top: -1rem!important;">
                        ...
                        <table class="table table-striped">
                            ...
                            $sn=1+$page;
							while ($user = mysqli_fetch_array($getsql)) { $category_id = $user['category_id'];  ?>
                                <tr>
                                    <td><?= $sn++; ?></td>
                                    <td><?= ucfirst($user['category_name']) ?> <input type="hidden" value="<?=$user['category_name']?>" id="update<?=$category_id;?>" /> </td>
									<td><a href="" class="btn-sm btn-primary" title="Add Category" onclick="return editCategory(<?=$category_id;?>)" data-toggle="modal" data-target="#exampleModalEdit" data-backdrop="static" data-keyboard="false" data-whatever="@fat" ><i class="fa fa-pencil-square-o"></i></a> </td>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h1 class="modal-title" id="exampleModalLabel" style="color:#394A59;">Category</h1>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h1 class="modal-title" id="exampleModalLabel" style="color:#394A59;">Edit Thematic Area</h1>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
...
<?php
	if($_SESSION['status']=='add-category' && $_SESSION['status']!=''){ ?>
		<script>toastr.success('Category Added Successfully..!', 'Success Alert', {timeOut: 5000});</script>
	<?php $_SESSION['status']='';
	}
?>
...
<?php
	if($_SESSION['statuss']=='Edit-category' && $_SESSION['statuss']!=''){ ?>
		<script>toastr.success('Category Updated Successfully..!', 'Success Alert', {timeOut: 5000});</script>

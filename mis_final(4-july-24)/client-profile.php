	...
	<div class="row">
		<div class="col-lg-12">
			<ol class="breadcrumb">
				...
				<!--<li><i class="icon_documents_alt"></i>Client List</li>-->
				<li><i class="fa fa-users" aria-hidden="true"></i>User Profile</li>
			</ol>
		</div>
	</div>
	<!-- page start-->
			...
			<div class="profile-widget profile-widget-info">
				<div class="panel-body">
					...
					<div class="col-lg-2 col-sm-8 follow-info weather-category">
						...
						<ul>
							<li class="active">
								<i class="fa fa-times-circle fa-2x"></i><br> Unpublish : <b><?=$data['total_unpublish'];?> <?php //$sssv=subscription_services($conn,$_SESSION['user_id']); print_r($sssv);?></b>
							</li>
						</ul>
					</div>
					<div class="col-lg-2 col-sm-8 follow-info weather-category">
						...
						<ul>
							<li class="active">
								<i class="fa <?=$iconss?> fa-2x"></i><br> Subcription : <b><?=$textss;?> <?php //$sssv=subscription_services($conn,$_SESSION['user_id']); print_r($sssv);?></b>
							</li>
						</ul>
					</div>
					<?php } ?>
					...
					<div class="col-lg-2 col-sm-8 follow-info weather-category">
						...
						<ul>
							<li class="active">
								<i class="fa fa-check-circle fa-2x" aria-hidden="true"></i><br>Number of Entries Verified: <b><?php echo '<span class="text-left tooltips" data-placement="top" data-toggle="tooltip" data-html="true" data-original-title="Terminated: '.$datater['tot_terminated'].'<br>Send for review: '.$datasend['send_for_review'].'">'.$data['total_accept'].'</span>';?></b>
							</li>
						</ul>
					</div>
					<div class="col-lg-2 col-sm-8 follow-info weather-category">
									...
									<div class="activity-body act-in">
										...
										<div class="col-lg-6">
											...
											<?php
											 ...
											 ?>
												<p class="attribution"><a href="#">User name : </a> <?=$getdata['name']?></p><hr>
												<p class="attribution"><a href="#">Device name : </a> <?=$getdata['device_name']?></p><hr>
												<p class="attribution"><a href="#">Last Login date :</a> <?php if($getdata['date_time']!=""){ echo date("d-M-Y",strtotime($getdata['date_time']));}?></p><hr>
										...
										<div class="col-lg-6">
											...
											<?php
											 ...
											 ?>
												<p class="attribution"><a href="#">Client name : </a> <?=$getclientdata['name']?></p><hr>
												<p class="attribution"><a href="#">Device name : </a> <?=$getclientdata['device_name']?></p><hr>
												<p class="attribution"><a href="#">Last Login date :</a> <?php if($getclientdata['date_time']!=""){ echo date("d-M-Y",strtotime($getclientdata['date_time']));}?></p><hr>
													...
													<div class="act-time">
														<div class="activity-body act-in">
															...
															<li><span class="attribution" style="font-size:15px;">Number of Entries Collected: <?=$data['total_monitoring']?></span></li>
																...
																?>
															<li><span class="attribution" style="font-size:15px;">Number of Entries Verified: <?=$data['accsql']?></span><br><li>
															<?php
															...
															?>
															<li><span class="attribution" style="font-size:15px;">Number of Entries Terminated: <?=$terminatesql;?></span>
															</li>
															<?php

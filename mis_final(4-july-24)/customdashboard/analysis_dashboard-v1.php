		...
		<?php if($survey_id!=''){?>
         ...
         <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
            <div class="info-box twoColor">
               ...
               <div class="count">
                  <?php  
                     $surveyverify=mysqli_query($conn,"SELECT COUNT(survey_data_monitoring_id) as acc_total FROM survey_data_monitoring LEFT JOIN clients on survey_data_monitoring.client_id=clients.id where survey_status in (1,6) and survey_name_id='".$survey_id."'");
            ...
            <section class="panel">
               <div class="card">
                  ...
                  <header class="panel-heading"> Form Name: <?php echo $survey_name;?> <?php if($_SESSION['functional_role_id']!='3'){?>|| Client Name: <?php echo $client_name;?> <?php } ?>
					...
					<a href="javascript:void(0)" class="btn-primary btn-sm pull-right save-sequence" style="margin:4px;"><i class="fa fa-save"></i> Save Sequence</a>
				</header>
			   </div>
            </section>
        </div>

		 ...
		 <div class="col-md-3">
			<section class="panel">
				<div class="card">
					...
					<?php 
						$getQuestions = mysqli_query($conn,"SELECT question_id, question_name, dictionary_label, field_name,input_field_type  FROM questions_language WHERE survey_id='".$survey_id."' AND question_name!='' AND language_id='1' AND input_field_type!='note' and repeated='' and screened='' ");
		...
		<div class="col-md-7" style="padding-left: 0px">
			<section class="panel">
				<header class="panel-heading"> 
					...
					<a href="javascript:" data-toggle="modal" data-target="#chartCustomiseModal" class="badge badge-primary customModal" style="float: right; margin-top: 8px;" data-backdrop="static" data-keyboard="false" data-whatever="@fat" >Customize & Save</a>
				...
				<div class="panel-body" id="ssid">
					...
					<div id="sschartarea" style="height:400px"></div>
                </div>
		...
		<div class="col-md-2" id="accordion" style="padding-left: 0px">
			...
			<section class="panel" >
				<div class="card">
					...
					<div class="list-group" id="formQuestionsGroupBy" style="height: 213px; overflow: scroll;">
					...
					<?php 
						...
						?>
							<a class="list-group-item qFieldGroupBy" data-id="<?=$questionGby['field_name'];?>" href="javascript:void(0);"> <?=$questionGby['dictionary_label'] ? $questionGby['dictionary_label'] : $questionGby['question_name'] ;?></a>
						<?php 	
						}
					?>
					</div>

		...
		<div class="modal-content">
			<div class="modal-content">
                                                        <div class="modal-body text-center p-2">
                                                            ...
                                                            <div class="mt-2">
                                                                <h4 class="mb-3">  <b><i class="fa fa-exclamation-triangle"></i> Welcome <?=ucfirst($_SESSION['name'])?></b></h4>
																<br/>
                                                                ...
                                                                <div class="hstack gap-2 justify-content-center">
                                                                    <a href="../pricing-new.php" class="btn btn-primary">Buy Now</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

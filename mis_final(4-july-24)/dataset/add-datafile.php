...
<?php define("title", "Add Data | MQUAD"); ?>
...
if (isset($_POST['submit'])) {
	...
	$dataset_name = mysqli_real_escape_string($conn, $_POST['dataset_name']);
	...
	$ext = pathinfo($data_formate_names, PATHINFO_EXTENSION);
...
<section id="main-content">
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<ol class="breadcrumb">
					<li><i class="icon_documents_alt"></i>List Dataset(s)</li>
					<li><i class="fa fa-plus"></i>Add Data</li>
				</ol>
			</div>
		</div>
		<!-- page start-->
						...
						<div class="form">
							<form class="form-validate form-horizontal" id="myForm" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-lg-10">
										<input class="form-control" id="dataset_name" required name="dataset_name" type="text">
									</div>
								</div>
								...
								<div class="form-group">
									<label for="cname" class="control-label col-lg-2">Select Format: <span style="color:red;">*</span></label>
									<div class="col-lg-10">
										<select class="form-control form-select" required name="data_formet" id="formatSelect">
								...
								<div class="row" id="uploadOption" style="display: none;">
									<label for="cname" class="control-label col-lg-2">Upload File: <span style="color:red;">*</span></label>
									<div class="col-lg-10">
										<input type="file" class="form-control-file" name="file_upload" id="fileUpload">
									</div>
								</div>
								<div class="form-group" style="margin-top: 17px;">

...
if (isset($_REQUEST['qid']) && $_REQUEST['qid'] != '') {
   $getsqlques = mysqli_query($conn, "SELECT source_link,question_bank_id,data_source,target_group,question_bank_name,unique_id,question_type,categories.category_name FROM `question_bank` left join categories on question_bank.category_id=categories.category_id where question_bank_id='" . $_REQUEST['qid'] . "'");
...
if (isset($_POST['update_data'])) {
   ...
   $updatesql = "UPDATE question_bank SET source_link='".$source_link."',question_bank_name='" . $question_bank_name . "',data_source='" . $data_source . "',target_group='" . $target_group . "',$status_type,user_id='" . $user_id . "',question_type='" . $questions_type_id . "',category_id='" . $category_id . "' WHERE question_bank_id='" . $_REQUEST['qid'] . "'";
   ...
   <section class="wrapper">
      <div class="row">
         <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
               <li><i class="icon_documents_alt"></i>Show Questions</li>
               <li><i class="fa fa-plus"></i>Update Question Bank</li>
            </ol>
         </div>
      </div>
      <!-- page start-->
                  ...
                  <div class="form">
                     <form class="form-validate form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group ">
                           ...
                           <div class="col-lg-10">
                              <select class="form-control select2" name="questions_type_id" id="questions_type_id">
                        ...
                        <!------------------------------End select Multiple------------------------------------>
                        <!------------------------------radio button------------------------------------>
                        <div class="form-group" id="statedivradio" style="<?php if ($data['question_type'] == "radio_button") {
                                                                              echo "display: block";
                                                                           } else {
                                                                              echo "display:none";
                                                                           } ?>">
                        ...
                        <div class="form-group ">
                           <label for="cname" class="control-label col-lg-2">Thematic Area: </label>
                           <div class="col-lg-10">
                              <select class="form-control select2" name="category_id" id="category_id">
                                 <option value="">Information Area</option>
                                 <?php
                                 ...
                                 ?>
                                    <option value="<?= $category['category_id'] ?>" <?php if ($category['category_name'] == $data['category_name']) {
                                                                                       echo "selected";

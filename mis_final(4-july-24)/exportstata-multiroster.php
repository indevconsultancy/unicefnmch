...
<?php 
	...
	$external_ques.='    str    GPS    1:   79-100'."\n";
...
<?php
	...
	$getMondatas = mysqli_query($conn,"SELECT survey_data_monitoring_id, survey_id, survey_data_json, full_json FROM survey_data_monitoring WHERE survey_name_id='".$surveyid."' and survey_status!='7'");

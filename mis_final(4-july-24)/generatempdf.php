				...
				$output .= '<table cellspacing="0" cellpadding="0" width="100%" class="table table-bordered" style="border: 1px solid #00000059;">
					  <thead>
						<tr style="background: #61b8a4fc;color: white;text-align: left;">
						  <th style="border: 1px solid #00000059;padding:5px;text-align: left;">Field Name</th>
						  <th style="border: 1px solid #00000059;padding:5px;text-align: left;">Questions</th>
						  <th style="border: 1px solid #00000059;padding:5px;text-align: left;">Option Value</th>
						  <th style="border: 1px solid #00000059;padding:5px;text-align: left;">Skip/Remark</th>
						</tr>
					  </thead>
					  <tbody>';
				$output .= $looprtr;

      ...
      <div class="login-wrap">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<span class="input-group-addon float-right" style="margin-top:-35px; margin-right:20px;"> <a href="javascript:void(0)" onclick="myFunctionnew();"> <i class="fa fa-eye" aria-hidden="true"></i> </a> </span>
				</div>
				...
				<div class="col-md-12">
					...
					<span class="input-group-addon float-right" style="margin-top:-35px; margin-right:20px;"> <a href="javascript:void(0)" onclick="myFunctionconfirm();"> <i class="fa fa-eye" aria-hidden="true"></i> </a> </span>
					</div>

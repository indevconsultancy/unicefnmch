    ...
    <div class="row">
      <div class="col-lg-12">
        <ol class="breadcrumb">
          ...
          <li><i class="fa fa-users" aria-hidden="true"></i>Client Management</li>
          <li><i class="fa fa-plus"></i>Add Client</li>
        </ol>
      </div>
    </div>
    <!-- page start-->  
              ...
              <div class="panel-body">
                ...
                <form class="form-validate form-horizontal " id="registration_form" method="post" enctype="multipart/form-data">
                    <div class="form-group ">
                      <label for="fullname" class="control-label col-lg-2">Register As<span class="required" style="color:red">*</span></label>
						<div class="col-lg-10"> 
							<select class="form-control" name="registered_as" required>
                      ...
                      <label for="membership_id" class="control-label col-lg-2">Membership<span class="required" style="color:red">*</span></label>
						<div class="col-lg-10">
							<select class="form-control" name="membership_id" required>
								...
								<option value="1"<?php //if(isset($_REQUEST['membership_id'])){ echo "selected";} ?>>Basic</option>
								<option value="2"<?php //if(isset($_REQUEST['membership_id'])){ echo "selected";} ?>>Standard</option>
								<option value="3"<?php //if(isset($_REQUEST['membership_id'])){ echo "selected";} ?>>Advance</option>
				...
				<div class="form-group ">
					...
					<div class="col-lg-10">
						<select class="form-control" name="role_master_id" required>
							...
							<?php  
								...
								{?>
									<option value="<?=$type['id'];?>"<?php if(isset($_REQUEST['role_master_id'])){ echo "selected";} ?>><?=$type['name'];?></option>
								<?php } ?>
						</select>
                    </div>
				</div>
					...
					<div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control " id="email" name="email" type="text" value="<?php if(isset($_REQUEST['submit'])){ echo $_REQUEST['email'];} ?>"/>
						<p id="statususer"></p>
					  </div>
                    </div>
					<div class="form-group ">

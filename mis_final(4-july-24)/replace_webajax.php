					...
					/* $multilangHtml.="
					 ...
					 $multilangHtml.='
						<li>
							...
							<input type="text" class="form-control multi_language multi-two"  name="lang-hint[]" placeholder="Hint*" value="'.htmlspecialchars(stripslashes($val_hint), ENT_QUOTES, 'UTF-8').'" '.$disabled_multilang_two.' />
								...
								<div class="edit-main-container" style="display: none;">
									<div class="edit-wrapper-container">
										...
										<div>
											...
											<input type="text" class="form-control mt-1 mb-3 q_name" name="name" value="$name" readonly>
								...
								<div class="edit-main-container" style="display: none;">
									<div class="edit-wrapper-container">
										...
										<div>
											...
											<input type="text" class="form-control mt-1 mb-3 q_name" name="name" value="$name" id="inputField" onkeydown="blockInvalidKeys(event)" oninput="validateInput(this)" readonly>
				...
				foreach($qoptions as $qoption){
					...
					$optdec.=<<<OPTDEC
							<li>
								...
								<input type="text" class="form-control" name="option-name[]" placeholder="Option Name" value='$qoptn_label' disabled>
								<input type="text" class="form-control" name="option-val[]" placeholder="Option Value" value="$qoptn->value" disabled>
								$multioptionlabels
							</li>
							OPTDEC;
					$opt.=<<<OPT
							...
							<!--	<input type="text" class="form-control" placeholder="Type: Select One Option" readonly> -->
								...
								<div class="edit-main-container" style="display: none;">
									...
									<!--	<div>
										...
										<!--	<div class="add-field" id="add-field-option" style="pointer-events: none">
			...
			if($type==='select_multiple'){
				...
				foreach($qoptions as $qoption){
					...
					$optdec.=<<<OPTDEC
							<li>
								<input type="radio" class="option-selected" checked="checked" class="form-checkbox">
								<input type="text" class="form-control" name="option-name[]" placeholder="Option Name" value='$qoptn_label' >
								<input type="text" class="form-control" name="option-val[]" placeholder="Option Value" value="$qoptn->value" >
								$multioptionlabels
							</li>
							OPTDEC;
					$opt.=<<<OPT
				...
				$existingQuestions=<<<SSS
						<div class="number-seaction">
							...
							<div class="label"><span class="label-name">$name: </span><span class="label-text">$label</span><span class="text-danger required_star">*</span></div> 
							<div class="input-seaction">
							<!--	<select class="form-control ques" name="$name" id="select-$key">	
						...
						<div class="edit-main-container" style="display: none;">
							<div class="edit-wrapper-container">
								<div>
									...
									<input type="text" class="form-control mt-1 mb-3 q_name" value="$name" name="group-name" readonly>

		...
		<div class="col-md-12">
			<section class="panel">
				<header class="panel-heading"> 
					Replace Web Form  
				<!--	<a href="javascript:void(0)" class="btn btn-success pull-right" id="downloadExcel" > <i class="fa fa-download"></i> Download Excel</a>-->
					<a href="javascript:void(0)" class="btn btn-success pull-right" id="publishwebform" >Update Form</a>
					<a href="javascript:void(0)" class="btn btn-success pull-right" id="savequesbtn" >Update Form Fields</a>
                ...
                <div class="edit-wrapper-container">
					...
					<div>
						<label class="form-check-label">
							...
							<i data-html="true" data-toggle="tooltip" title="It contains a database field name for the input. For example, a field named 'student_email' contains the email address of each student." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							...
							<i data-html="true" data-toggle="tooltip" title="A field label is descriptive text that helps users understand what information to enter in a web form input field." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							Dictionary Label
							<i data-html="true" data-toggle="tooltip" title="A descriptive or identifying word or phrase." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							Hint
							<i data-html="true" data-toggle="tooltip" title="A field hint is a short description of a field that appears when a user hovers over it." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							...
							<i data-html="true" data-toggle="tooltip" title="The 'field limit' is like setting rules for how much and what type of information people can put into each box." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							Constraint
							<i data-html="true" data-toggle="tooltip" title="Constraint in the context of web forms refers to rules or limitations placed on the input data that users can provide." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							Constraint Message
							<i data-html="true" data-toggle="tooltip" title="Constraint message refers to the feedback or error message displayed to users when they attempt to submit data that violates a constraint." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							Paradata
							<i data-html="true" data-toggle="tooltip" title="Paradata includes information about how respondents interact with the form or survey." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							Appearance
							<i data-html="true" data-toggle="tooltip" title="Appearance refers to the visual presentation and layout of the form elements as they are displayed to users." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							Choice Filter
							<i data-html="true" data-toggle="tooltip" title="A choice filter enables users to refine their selections within dropdown menus or other selection lists based on the values they've chosen in other related fields." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							Repeat Count
							<i data-html="true" data-toggle="tooltip" title="The repeat count functionality allows you to create repeating sections within the repeat group section, where the same group of questions or fields can be filled out multiple times." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							Calculation
							<i data-html="true" data-toggle="tooltip" title="Calculation typically refers to the automatic computation or derivation of a value based on the input provided by the user in other fields." class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div>
						<label class="form-check-label">
							Default Response
							<i data-html="true" data-toggle="tooltip" title="Default Response refers to pre-selected value that is automatically displayed in an input field when the form is initially loaded" class="fa fa-info-circle tooltip-icon"></i>
						</label>
					...
					<div class="fw">
						<div>
							<label class="form-check-label">
								Multilingual
								<i data-html="true" data-toggle="tooltip" title="Click on Add Multilingual Button to add new language." class="fa fa-info-circle tooltip-icon"></i>
							</label>
						</div>
						<div class="row">
							<div class="col-md-12">
					...
					<div class="fw">
						<div>
							<label class="form-check-label">
								Relevant
								<i data-html="true" data-toggle="tooltip" title="Click on Add Relevant Button to add new relevant." class="fa fa-info-circle tooltip-icon"></i>
							</label>
						</div>
						<div class="row">
							<div class="col-md-12">
		...
		if(parent_div == 'FIELDSET'){
			...
			var numbersec = `<div class="number-seaction">
				...
				<div class="input-seaction">
					<input class="form-control ques" name="number-`+w+`" type="number" id="number-`+w+`" placeholder="Enter a Number" readonly>
				</div>
			</div>`;
			...
			var numbersec = `<div class="number-seaction">
				...
				<div class="label"><span class="label-text">Number-`+ x + `</span><span class="text-danger required_star">*</span></div> 
				<div class="input-seaction">
					<input class="form-control ques" name="number-`+x+`" type="number" id="number-`+x+`" placeholder="Enter a Number" readonly>
				</div>
			</div>`;
	...
	$(document).on("click", ".text", function () {
		...
		if(parent_div == 'FIELDSET'){
			...
			var textsec = `<div class="text-seaction">
				...
				<div class="input-seaction">
					<input class="form-control ques" name="text-`+w3+`" type="text" id="text-`+w3+`" placeholder="Enter a text value" readonly>
			...
			var textsec = `<div class="text-seaction">
				...
				<div class="input-seaction">
					<input class="form-control ques" name="text-`+x3+`" type="text" id="text-`+x3+`" placeholder="Enter a text value" readonly>

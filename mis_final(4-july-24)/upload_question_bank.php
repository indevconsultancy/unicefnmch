...
<section id="main-content">
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                <ol class="breadcrumb">
                    <li><i class="icon_documents_alt"></i>Quesion bank </li>
                    <li><i class="fa fa-plus"></i>Upload question bank </li>
                </ol>
            </div>
        </div>
        <!-- page start-->
            ...
            for ($row = 2; $row <= $highestRow; $row++) {
                ...
                if (!empty($question_bank_name) && !empty($field_name) && !empty($category_id) && !empty($data_source)) {
                    ...
                    if (mysqli_num_rows($getCategory) > 0) {
                        $getquestion = "INSERT INTO question_bank SET unique_id='$uniqueid', question_bank_name='$question_bank_name', field_name='$field_name', question_type='$question_type', category_id='$category_id', theme_id='$theme_id', common_use='0', data_source='$data_source', source_link='$source_link', user_id='$user_id'";
									...
									<div class="form">
										...
										<label for="cname" class="control-label">Select File: </label>
											<div class="form-group" style="border-bottom: none !important;">
												  ...
												  <input class="form-control tooltips" name="file_upload" accept=".xlsx,.xls," data-placement="top" data-toggle="tooltip" required data-original-title="Upload Question bank" type="file" />

...
<section class="wrapper">
	...
	<div class="row">
		...
		<div class="col-lg-12">
			<ol class="breadcrumb">
				<li><i class="fa fa-list"></i>Client List</li>
				<li><i class="fa fa-users" aria-hidden="true"></i>Client Profile</li>
			</ol>
		</div>
	</div>
	<!-- page start-->
			...
			<div class="profile-widget profile-widget-info">
				<div class="panel-body">
					<!--<div class="col-lg-2 col-sm-2">
						...
						<?php
							//if($data['profile_img']!=''){ ?>
								<img src="img/<?php //echo $data['profile_img']?>" alt="">
							<?php //} else{ ?>
								<img src="img/user1.png" alt="">
							<?php	//} ?>
							
						</div>
						<h6><?php //echo $data['role_type_name']?></h6>
								...
								<div class="act-time">
									<div class="activity-body act-in">
										...
										<?php
										 ...
										 ?>
											<p class="attribution">User name: </a> <?=$getdata['name']?></p><hr>
											<p class="attribution">Last forms collected: </a> <?php if($getdata['created_on']!=""){ echo date("d-M-Y",strtotime($getdata['created_on']));}?></p><hr>
												...
												<div class="profile-activity">
													<div class="act-time">
														<div class="activity-body act-in">
															...
															?>
															<p class="attribution" style="font-size:15px;"><a href="#" style="font-size:15px;">Total Form Collected: </a> <?=$data['total_monitoring']?></p><hr>
																<?php
																	...
																	//echo $data['total_acc'];
																?>
															<p class="attribution" style="font-size:15px;"><a href="#" style="font-size:15px;">Accepted Form Collected: </a> <?=$data['total_acc']?></p><hr>
															<?php
																...
																//echo $data['total_rej'];
															?>
															<p class="attribution" style="font-size:15px;"><a href="#" style="font-size:15px;">Rejected Form Collected: </a> <?=$data['total_rej']?></p>
															</div>
														</div>
													</div>
												</div>

 ...
 <?php include('includes/sidebar.php');
  ...
  $sqlsummarySales=mysqli_query($conn,"select (select sum(AmountInUSD) from pm_payments where PaymentStatus='Completed') as totalAmount, (select count(OrderID) from pm_orders where Status='Completed') as totalOrders, (select count(distinct(client_id)) from pm_usersubscriptions where PaymentID>0) as totalActiveClients, (select count(distinct(client_id)) from pm_usersubscriptions where Status='Expired') as totalExpired");
  $datasummarySales=mysqli_fetch_object($sqlsummarySales);
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-16 mb-1">Good Morning, Sales Team!</h4>
                                                <p class="text-muted mb-0">Here's what's happening with your product sales.</p>
                                            </div>
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">$<span class="counter-value" data-target="<?=$datasummarySales->totalAmount;?>">0</span> </h4>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?=$datasummarySales->totalOrders;?>">0</span></h4>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0">Subscriber(s)</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <h5 class="text-success fs-14 mb-0">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?=$datasummarySales->totalActiveClients;?>">0</span></h4>
                                    ...
                                    <div class="col-xl-3 col-md-6">
                                        ...
                                        <div class="card card-animate">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <p class="text-uppercase fw-medium text-muted text-truncate mb-0"> Renewal(s) Pending</p>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                ...
                                                <div class="d-flex align-items-end justify-content-between mt-4">
                                                    <div>
                                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value" data-target="<?=$datasummarySales->totalExpired;?>">0</span></h4>

        ...
        <div class="layout-width">
            <div class="navbar-header">
                ...
                <div class="horizontal-logo">
                    <a href="index.php" class="navbar-brand fs-4 text-white fw-semibold my-2 d-flex align-items-center">
                        <div class="logo-home  me-2"><img src="assets/images/bihar-sarkar.png" width="60" class="w-100"> </div><b>सुपोषित ग्राम पंचायत अभियान</b></h4>
                    </a>
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                ...
                                <span class="d-none d-xl-block ms-1 fs-12 user-name-sub-text text-white">ICDS</span>
                            </span>
                        </span>
                    </button>
                ...
                <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarApps">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
								 ...
								 <!--<li class="nav-item">
                                    <a href="#" class="nav-link" data-key="t-calendar"> Blocks
                                    </a>
                                </li>-->
								 <li class="nav-item">
                                    <a href="gp-list.php" class="nav-link" data-key="t-calendar"> Gram Panchayats
                                    </a>
                                </li>
								 <li class="nav-item">
                                    <a href="#" class="nav-link" data-key="t-calendar"> Anaganwadi
                                    </a>
                                </li>
                            </ul>
                        </div>							
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                            ...
                            <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Reports</span> <span
                        ...
                        <div class="collapse menu-dropdown" id="sidebarLayouts">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="awc-report.php" target="_blank" class="nav-link"
                                        data-key="t-detached">Quality Report</a>
                                </li>
								<li class="nav-item">
                                    <a href="#" target="_blank" class="nav-link"
                                        data-key="t-horizontal">Analysis Report</a>
                                </li>
					...
					<li class="nav-item">
                        <a class="nav-link menu-link" href="resources.php">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Resources</span>
                        </a>
					...
					<li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarLayouts" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="sidebarLayouts">
                             <i class="ri-account-circle-line"></i> <span data-key="t-layouts">Users</span> <span
                                class="badge badge-pill bg-danger" data-key="t-hot">Hot</span>
                        </a>
                        <div class="collapse menu-dropdown" id="sidebarLayouts">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="#" target="_blank" class="nav-link"
                                        data-key="t-horizontal">Data Collector</a>
                                </li>
                                <li class="nav-item">
                                    <a href="#" target="_blank" class="nav-link"
                                        data-key="t-detached">Web Users</a>
                                </li>

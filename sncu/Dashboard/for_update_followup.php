...
/*
$sqlqry=mysqli_query($conn,"select md.id,md.registration_id,md.baby_weight,md.baby_length,md.baby_head_circumference,reg.sex,DATEDIFF(md.date_of_visit,reg.baby_date_of_birth) AS age_months,reg.gestational_age_LBW from follow_up md,registration_form reg where md.registration_id=reg.id and md.type_of_time!='' and md.baby_weight>0 and md.growth_status=0 limit 0,50");
...
$sqlqry=mysqli_query($conn,"select md.id,md.registration_id,md.baby_weight,md.baby_length,md.baby_head_circumference,reg.sex,DATEDIFF(md.date_of_visit,reg.baby_date_of_birth) AS age_months,reg.gestational_age_LBW from follow_up md,registration_form reg where md.registration_id=reg.id and md.type_of_time!='' and md.baby_weight>0 and reg.gestational_age_LBW>=22 and md.growth_status_fenton=0 limit 0,50 ");

...
//echo "SELECT COUNT(rf.id)FROM registration_form rf  JOIN monitoring_data adm ON rf.id = adm.registration_id AND adm.type_of_monitoring = 'Date of Admission' LEFT JOIN monitoring_data dis ON rf.id = dis.registration_id AND dis.type_of_monitoring = 'Discharge Day' LEFT JOIN follow_up fal ON rf.id = fal.registration_id $filter";

$total_reg = mysqli_fetch_row(mysqli_query($conn, "SELECT COUNT(rf.id)FROM registration_form rf  JOIN monitoring_data adm ON rf.id = adm.registration_id AND adm.type_of_monitoring = 'Date of Admission' LEFT JOIN monitoring_data dis ON rf.id = dis.registration_id AND dis.type_of_monitoring = 'Discharge Day' LEFT JOIN follow_up fal ON rf.id = fal.registration_id $filter"))[0];
                ...
                <div class="table-responsive table-card mt-3 mb-1">
                  <table class="table align-middle table-nowrap" id="full_child_detail">
                    <thead class="table-light">
                      <!--<tr>
                        <td colspan="26" data-f-bold='true' data-fill-color='FFFDAF' data-b-a-s='thin' data-b-a-c='000000' style="background-color: #fffdaf; font-size: 20px; text-align: Left; font-weight: bold;">Registration</td>
                        <td colspan="37" data-f-bold='true' data-fill-color='EAE8E0' data-b-a-s='thin' data-b-a-c='000000' style="background-color: #eae8e0; font-size: 20px; text-align: Left; font-weight: bold;">Admission</td>
                        <td colspan="39" data-f-bold='true' data-fill-color='FFEFEF' data-b-a-s='thin' data-b-a-c='000000' style="background-color: #ffefef; font-size: 20px; text-align: Left; font-weight: bold;">Discharge</td>
                      
                        <td colspan="49" data-f-bold='true' data-fill-color='20E4EB' data-b-a-s='thin' data-b-a-c='000000' style="background-color: #20e4eb; font-size: 20px; text-align: Left; font-weight: bold;">Post-discharge First Follow-Up (8 days)</td>
                        <td colspan="49" data-f-bold='true' data-fill-color='86E94D' data-b-a-s='thin' data-b-a-c='000000' style="background-color: #86e94d; font-size: 20px; text-align: Left; font-weight: bold;">Post-discharge Second Follow-Up (1 Month)</td>
                        <td colspan="49" data-f-bold='true' data-fill-color='EBC51E' data-b-a-s='thin' data-b-a-c='000000' style="background-color: #ebc51e; font-size: 20px; text-align: Left; font-weight: bold;">Post-discharge Third Follow-Up (3 Month)</td>
                        <td colspan="49" data-f-bold='true' data-fill-color='D63DCF' data-b-a-s='thin' data-b-a-c='000000' style="background-color: #d63dcf; font-size: 20px; text-align: Left; font-weight: bold;">Post-discharge Fourth Follow-Up (6 Month)</td>
                        <td colspan="49" data-f-bold='true' data-fill-color='B4B9AF' data-b-a-s='thin' data-b-a-c='000000' style="background-color: #b4b9af; font-size: 20px; text-align: Left; font-weight: bold;">Post-discharge Fifth Follow-Up (1 Year)</td>
                      </tr>
                      <tr>-->
                        <!-- registration -->
                        ...
                        <tr>
                          ...
                          <td class="customer_name">
                            ...
                            if (!empty($postdisdata->gestational_age_LBW) && !empty($postdisdata->date_of_admission) && !empty($postdisdata->baby_date_of_birth)) {
                              ...
                              $days_diff = abs((strtotime($postdisdata->date_of_admission) - strtotime($postdisdata->baby_date_of_birth)) / 86400);
                          ...
                          <td class="customer_name">
                            ...
                            if (!empty($postdisdata->gestational_age_LBW) && !empty($postdisdata->discharge_date) && !empty($postdisdata->baby_date_of_birth)) {
                              $ga_at_birth = $postdisdata->gestational_age_LBW;
                              $days_diff = abs((strtotime($postdisdata->discharge_date) - strtotime($postdisdata->baby_date_of_birth)) / 86400);
                              $total_ga = floor($ga_at_birth + ($days_diff / 7));
                              echo $total_ga;
                            }
                            ?>
                          ...
                          <td>
                            <?php
                            $visit_date = getfallowup($conn, 'follow_up', $postdisdata->id, 'date_of_visit', '8 Days');
                            $dob = $postdisdata->baby_date_of_birth;

                            if (!empty($visit_date) && !empty($dob)) {
                              $days_diff = ((strtotime($visit_date) - strtotime($dob)) / 86400);
                              echo $days_diff;
                            }
                            ?>
                          </td>
                          <td>
                            ...
                            $visit_date = getfallowup($conn, 'follow_up', $postdisdata->id, 'date_of_visit', '8 Days');
                            $dob = $postdisdata->baby_date_of_birth;
                            $ga = $postdisdata->gestational_age_LBW;

                            if (!empty($visit_date) && !empty($dob) && !empty($ga)) {
                              $days_diff = abs((strtotime($visit_date) - strtotime($dob)) / 86400);
                              echo round($ga + ($days_diff / 7));
                            }
                            ?>
                          </td>
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Breast_milk', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Animal_milk', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Formula_milk', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Water', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Others', '8 Days') ?></td>
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'asha_check_following_infant', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Weight', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Temparature', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Respiratory_rate', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Pus_on_umbilicus', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Eyes', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Urine_frequency', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_none', '8 Days') ?></td>
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_wtage', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_lenage', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_wtlen', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_head_circum_per', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_wtage', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_lenage', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_head_circum', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_per_wtage', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_per_lenage', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_head_circum_per', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_wtage', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_lenage', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_head_circum', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_per_wtage', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_per_lenage', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_head_circum_per', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_classification', '8 Days') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_growth_classification', '8 Days') ?></td>
						  <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_classification', '8 Days') ?></td>
                          <!-- Fallow Up 1 Month -->
                          ...
                          <td>
                            <?php
                            $visit_date = getfallowup($conn, 'follow_up', $postdisdata->id, 'date_of_visit', '1 Month');
                            $dob = $postdisdata->baby_date_of_birth;
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Breast_milk', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Animal_milk', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Formula_milk', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Water', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Others', '1 Month') ?></td>
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'asha_check_following_infant', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Weight', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Temparature', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Respiratory_rate', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Pus_on_umbilicus', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Eyes', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Urine_frequency', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_none', '1 Month') ?></td>
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_wtage', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_lenage', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_wtlen', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_head_circum_per', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_wtage', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_lenage', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_head_circum', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_per_wtage', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_per_lenage', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_head_circum_per', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_wtage', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_lenage', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_head_circum', '1 Months') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_per_wtage', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_per_lenage', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_head_circum_per', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_classification', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_growth_classification', '1 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_classification', '1 Month') ?></td>
                          <!-- Fallow Up 3 Month -->
                          ...
                          <td>
                            <?php
                            $visit_date = getfallowup($conn, 'follow_up', $postdisdata->id, 'date_of_visit', '3 Month');
                            $dob = $postdisdata->baby_date_of_birth;
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Breast_milk', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Animal_milk', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Formula_milk', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Water', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Others', '3 Month') ?></td>
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'asha_check_following_infant', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Weight', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Temparature', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Respiratory_rate', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Pus_on_umbilicus', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Eyes', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Urine_frequency', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_none', '3 Month') ?></td>
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_wtage', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_lenage', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_wtlen', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_head_circum_per', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_wtage', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_lenage', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_head_circum', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_per_wtage', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_per_lenage', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_head_circum_per', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_wtage', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_lenage', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_head_circum', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_per_wtage', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_per_lenage', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_head_circum_per', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_classification', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_growth_classification', '3 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_classification', '3 Month') ?></td>
                          <!-- Fallow Up 6 Month -->
                          ...
                          <td>
                            <?php
                            $visit_date = getfallowup($conn, 'follow_up', $postdisdata->id, 'date_of_visit', '6 Month');
                            $dob = $postdisdata->baby_date_of_birth;
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Breast_milk', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Animal_milk', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Formula_milk', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Water', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Others', '6 Month') ?></td>
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'asha_check_following_infant', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Weight', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Temparature', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Respiratory_rate', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Pus_on_umbilicus', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Eyes', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Urine_frequency', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_none', '6 Month') ?></td>
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_wtage', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_lenage', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_wtlen', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_head_circum_per', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_wtage', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_lenage', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_head_circum', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_per_wtage', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_per_lenage', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_head_circum_per', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_wtage', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_lenage', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_head_circum', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_per_wtage', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_per_lenage', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_head_circum_per', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_classification', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_growth_classification', '6 Month') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_classification', '6 Month') ?></td>
                          <!-- Fallow Up 1 Year -->
                          ...
                          <td>
                            <?php
                            $visit_date = getfallowup($conn, 'follow_up', $postdisdata->id, 'date_of_visit', '1 Year');
                            $dob = $postdisdata->baby_date_of_birth;
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Breast_milk', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Animal_milk', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Formula_milk', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Water', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'tof_Others', '1 Year') ?></td>
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'asha_check_following_infant', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Weight', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Temparature', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Respiratory_rate', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Pus_on_umbilicus', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Eyes', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_Urine_frequency', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'check_none', '1 Year') ?></td>
                          ...
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_wtage', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_lenage', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_per_wtlen', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_head_circum_per', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_wtage', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_lenage', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_head_circum', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_per_wtage', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_per_lenage', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_head_circum_per', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_wtage', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_lenage', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_head_circum', '1 Years') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_per_wtage', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_per_lenage', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_head_circum_per', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'intergrowth_classification', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'fenton_growth_classification', '1 Year') ?></td>
                          <td><?= getfallowup($conn, 'follow_up', $postdisdata->id, 'who_classification', '1 Year') ?></td>
                        </tr>
                      <?php } ?>
                    </tbody>
                  </table>

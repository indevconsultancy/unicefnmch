...
try {
	...
	if($reason_for_admission!='')
	{
		$addExtra='';
		$typeoffeed = ['LBW','Preterm','Others'];
        $typeoffeed_column_name = ['reason_LBW','reason_Preterm','reason_Others'];
    $feedValues = array_map('trim', explode(',', $reason_for_admission));
    $updateFields = [];

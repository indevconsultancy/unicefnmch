...
<head>
	...
	<title>Validate Excel Form - Resources | MQUAD</title>
		...
		<div class="contactPageMain">
			<div class="header">
				<div class="headerImage">
					<img src="Content/Images/Resources/excel_form.svg" alt="Prides itself on outstanding customer service." title="Get in Touch with" />
				</div>
				<div class="headerTitle">
					<h4>Validate Excel Form</h4>
				</div>
			...
			<div class="mainContent mb-5">
				...
				<div>
					<div class="col-lg-12">
									...
									if ($file_check == 1) {
										...
										foreach ($objPHPExcel->getWorksheetIterator() as $worksheet) {
											...
											foreach ($selectOneChoisesArr as $key => $selectOneChoises) {
												...
												if ($selectOnelimitsArr[$key] < $optMaxLength) {
													$error_arr[] = "Error, limit should be " . $optMaxLength . " for question " . $key;
												}
											}
											...
											foreach ($selectMultiChoisesArr as $key => $selectMultiChoises) {
												...
												if ($selectMultilimitsArr[$key] < $optmMaxLength) {
													$error_arr[] = "Error, limit should be " . $optmMaxLength . " for question " . $key;
												}
											}
											...
											<div class="col-lg-offset-2 col-lg-10 text-right">
												...
												if (isset($_POST['VerifySurvey'])) {
													if (count($error_arr) > 0) {
														echo '<button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#xlsIssues" data-bs-backdrop="static" data-bs-keyboard="false">Error Found</button>';
													} else {
						...
						<div class="modal fade" id="xlsIssues" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
							<div class="modal-dialog" style="width: 45% !important;">
								<div class="modal-content">
									<div class="modal-header">
										<h3 class="modal-title m-0" style="color:#394A59;">XLS Errors:</h3>
										<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
									</div>
									<form action="" method="POST" enctype="multipart/form-data" style="max-height:370px; overflow-y: auto">
